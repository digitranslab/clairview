...
const packageJson = JSON.parse(fs.readFileSync(path.join(__dirname, '..', 'packages', 'cv-lib-gui', 'package.json'), 'utf8'))
...
fs.writeFileSync(path.join(__dirname, '..', 'packages', 'cv-lib-gui', 'package.json'), JSON.stringify(packageJson, 0, 2))