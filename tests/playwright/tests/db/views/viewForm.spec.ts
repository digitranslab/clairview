...
import { Api, StringValidationType, UITypes } from 'clairview-sdk';
...
test.describe('Form view with LTAR', () => {
  ...
  test('Form view with LTAR', async ({ page }) => {
    ...
    await loginPage.signIn({
      email: `user-${process.env.TEST_PARALLEL_INDEX}@clairview.com`,
...
test.describe('Form view: field validation', () => {
  ...
  test('Form builder field validation', async () => {
    ...
    await form.fillForm([{ field: 'Email', value: 'john@clairview.com' }]);
    await emailErrorConfig.verify({ hasError: false });
...
test.describe('Form view: conditional fields', () => {
  ...
  test('Form builder conditional field', async () => {
    ...
    const fieldConditionsList = [
      ...
      { column: 'Email', op: 'is not equal', value: 'user@clairview.com', dataType: UITypes.Email },
    ...
    await form.fillForm([{ field: 'Email', value: 'user1@clairview.com' }]);
    ...
    await form.fillForm([{ field: 'Email', value: 'user@clairview.com' }]);
