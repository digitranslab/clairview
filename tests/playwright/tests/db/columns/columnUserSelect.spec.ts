...
const users: string[] = isEE()
  ? [
      'useree@clairview.com',
      'useree-0@clairview.com',
      'useree-1@clairview.com',
      'useree-2@clairview.com',
      'useree-3@clairview.com',
    ]
  : [
      'user@clairview.com',
      'user-0@clairview.com',
      'user-1@clairview.com',
      'user-2@clairview.com',
      'user-3@clairview.com',
    ];

const roleDb = [
  { email: 'useree@clairview.com', role: 'editor' },
  { email: 'useree-0@clairview.com', role: 'editor' },
  { email: 'useree-1@clairview.com', role: 'editor' },
  { email: 'useree-2@clairview.com', role: 'editor' },
  { email: 'useree-3@clairview.com', role: 'editor' },
];
...
test.describe('User single select - filter, sort & GroupBy', () => {
  // Row values
  // only user@clairview.com (row 0)
  // only user-0@clairview.com (row 1)
  // only user-1@clairview.com (row 2)
  // only user-2@clairview.com (row 3)
  // only user-3@clairview.com (row 4)

  // Example filters:
  //
  // where tags contains all of [user@clairview.com]
  //   result: rows 0
  // where tags contains any of [user@clairview.com, user-0@clairview.com]
  //   result: rows 0,1
  // where tags does not contain any of [user@clairview.com, user-0@clairview.com]
  //   result: rows 2,3,4
  // where tags does not contain all of [user-0@clairview.com]
  //   result: rows 0,2,3,4
...
test.describe('User multiple select - filter, sort & GroupBy', () => {
  // Row values
  // only user@clairview.com (row 0)
  // user-0@clairview.com and user-1@clairview.com (row 1)
  // user-1@clairview.com and user-2@clairview.com (row 2)
  // user-2@clairview.com and user-3@clairview.com (row 3)
  // user-3@clairview.com and user@clairview.com (row 4)

  // Example filters:
  //
  // where tags contains all of [user-0@clairview.com, user-1@clairview.com]
  //   result: rows 1
  // where tags contains any of [user@clairview.com, user-0@clairview.com]
  //   result: rows 0,1,4
  // where tags does not contain any of [user@clairview.com, user-0@clairview.com]
