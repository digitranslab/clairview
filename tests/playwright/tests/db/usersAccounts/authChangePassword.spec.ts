...
test.describe.skip('Auth', () => {
  ...
  test('Change password', async ({ page }) => {
    ...
    await dashboard.grid.toolbar.share.invite({ email: 'user-1@clairview.com', role: 'creator' });
    ...
    await loginPage.fillEmail({ email: 'user-1@clairview.com' });
