...
const roleDb = [
  { email: 'creator@clairview.com', role: 'creator', url: '' },
  { email: 'editor@clairview.com', role: 'editor', url: '' },
  { email: 'commenter@clairview.com', role: 'commenter', url: '' },
  { email: 'viewer@clairview.com', role: 'viewer', url: '' },
];
