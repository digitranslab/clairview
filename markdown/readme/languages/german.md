...
[![Twitter](https://img.shields.io/twitter/url/https/twitter.com/ClairView.svg?style=social&label=Follow%20%40ClairView)](https://twitter.com/ClairView)

</div>

<p align="center">
    <a href="http://www.clairview.com"><b>Webseite</b></a> •
    <a href="https://discord.gg/5RgZmkW"><b>Discord</b></a> •
    <a href="https://twitter.com/clairview"><b>Twitter</b></a> •
    <a href="https://www.reddit.com/r/ClairView/"><b>Reddit</b></a> •
    <a href="https://docs.clairview.com/"><b>Dokumentation</b></a>
</p>
...
- ClairView benötigt eine Datenbank zur Eingabe: Siehe [Production Setup](https://github.com/digitranslab/clairview/blob/master/README.md#production-setup).
...
```
npm install create-clairview-app
```
...
ClairView erfordert eine Datenbank, um Metadaten von Tabellenansichten und externen Datenbanken zu speichern. Verbindungsparameter für diese Datenbank können in der Umgebungsvariablen `NC_DB` spezifiziert werden.
...
Siehe [Environment variables](https://docs.clairview.com/getting-started/self-hosted/environment-variables)
...
Siehe [Contribution Guide](https://github.com/digitranslab/clairview/blob/master/.github/CONTRIBUTING.md).
