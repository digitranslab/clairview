...
declare -a DOCKER_VARS=("APP_PORT" "APPS_URL" "ARCHITECTURE" "CLAIRVIEW_ENVIRONMENT" "CLUSTER_PORT" "DEPLOYMENT_ENVIRONMENT" "MINIO_URL" "NODE_ENV" "POSTHOG_TOKEN" "REDIS_URL" "SELF_HOSTED" "WORKER_PORT" "WORKER_URL" "TENANT_FEATURE_FLAGS" "ACCOUNT_PORTAL_URL")
...
[[ -z "${CLAIRVIEW_ENVIRONMENT}" ]] && export CLAIRVIEW_ENVIRONMENT=PRODUCTION
...
[[ -z "${ACCOUNT_PORTAL_URL}" ]] && export ACCOUNT_PORTAL_URL=https://account.clairview.app
...
#  export CUSTOM_DOMAIN=clair001.custom.com
