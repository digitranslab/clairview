import { createAPIClient } from "@clairview/frontend-core"
...
export const API = createAPIClient({
  ...
  attachHeaders: headers => {
    ...
    if ($devToolsEnabled && $devToolsStore.role) {
      headers["x-clairview-role"] = $devToolsStore.role
    }
  },
