<script>
  ...
  import { Layout, Heading, Body } from "@clairview/bbui"
  import ErrorSVG from "@clairview/frontend-core/assets/error.svg"
  import { Constants, CookieUtils } from "@clairview/frontend-core"
  import { getThemeClassNames } from "@clairview/shared-core"
                          ...
                          {:else if embedNoScreens}
                            <div class="error">
                              <Layout justifyItems="center" gap="S">
                                ...
                                {@html ErrorSVG}
                                <Heading size="L">
                                  This Clairview app is not publicly accessible
                                </Heading>
                              </Layout>
                            </div>
                          {:else}
