...
export interface paths {
  ...
  "/queries/{queryId}": {
    /** Queries which have been created within a Clairview app can be executed using this, */
  ...
  schemas: {
    ...
    applicationOutput: {
      data: {
        ...
        updatedAt: string;
        /** @description States the version of the Clairview client this app is currently based on. */
        version: string;
    ...
    rowSearch: {
      query: {
        ...
        /** @description Searches for a sub-string within a string column, e.g. searching for 'dib' will match 'Clairview'. */
...
export interface operations {
  appCreate: {
    parameters: {
      header: {
        ...
        "x-clairview-app-id": components["parameters"]["appId"];
      };
    };
    responses: {
  ...
  rowCreate: {
    ...
    responses: {
      /** Returns the created row, including the ID which has been generated for it. This can be found in the Clairview portal, viewed under the developer information. */
      200: {
        content: {
