import { App, Screen } from "@clairview/types"

import { db as dbCore } from "@clairview/backend-core"
    ...
    screen.props._children = [
      {
        ...
        _styles: {},
        _component: "@clairview/standard-components/tableblock",
        _id: "foo",
        linkRows: true,
        linkURL: "/rows/:id",
        linkPeek: true,
    ...
    screen.props._children = [
      {
        _instanceName: "Table",
        _styles: {},
        _component: "@clairview/standard-components/table",
        _id: "foo",
        linkRows: true,
        linkURL: "/rows/:id",
        linkPeek: true,
