...
import { FieldType, Table, Row, TableSourceType } from "@clairview/types"
import { DEFAULT_BB_DATASOURCE_ID } from "../../../constants"
import { objectStore, db, context } from "@clairview/backend-core"
import * as uuid from "uuid"

const BUCKET = "prod-clair-app-assets"
const FILE_NAME = "file/thing.jpg"
const DEV_APPID = "abc_dev_123"
const PROD_APPID = "abc_123"

jest.mock("@clairview/backend-core", () => {
  const actual = jest.requireActual("@clairview/backend-core")
  return {
    ...actual,
    context: {
      ...actual.context,
