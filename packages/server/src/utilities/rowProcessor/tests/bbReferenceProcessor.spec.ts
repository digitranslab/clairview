...
import * as backendCore from "@clairview/backend-core"
import { BBReferenceFieldSubType, User } from "@clairview/types"
import {
...
import {
  ...
  generator,
  structures,
} from "@clairview/backend-core/tests"
import { InvalidBBRefError } from "../errors"

jest.mock("@clairview/backend-core", (): typeof backendCore => {
  const actual: typeof backendCore = jest.requireActual(
    "@clairview/backend-core"
  )
  return {
    ...actual,
    cache: {
