...
import { context, InternalTable, tenancy, utils } from "@clairview/backend-core"
...
import { generator, mocks } from "@clairview/backend-core/tests"
import _, { merge } from "lodash"
import * as uuid from "uuid"
import { Knex } from "knex"
import { InternalTables } from "../../../db/utils"
import { withEnv } from "../../../environment"
import { JsTimeoutError } from "@clairview/string-templates"
    ...
    ({ config, dsProvider, isInternal, isMSSQL, isOracle }) => {
      ...
      describe("patch", () => {
        ...
        !isInternal &&
          ...
          // to identity columns. This is not something Clairview does currently.
          !isMSSQL &&
              ...
              return context.doInAppContext(config.getAppId(), async () => {
                ...
                for (const entry of attachmentEntries) {
                  ...
                  expect(entry.url.split("?")[0]).toBe(
                    `/files/signed/prod-clair-app-assets/${config.getProdAppId()}/attachments/${attachmentId}`
                  )
                }
              })
            })
