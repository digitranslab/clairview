...
import { generator } from "@clairview/backend-core/tests"
...
function setManifest(manifest: Manifest) {
  nock("https://prod-clair-templates.s3-eu-west-1.amazonaws.com")
    .get("/manifest.json")
    .reply(200, manifest)
}
    ...
    templates: {
      app: {
        "Agency Client Portal": {
          ...
          url: "https://clairview.com/portals/templates/agency-client-portal-template/",
          type: "app",
          key: "app/agency-client-portal",
          image:
            "https://prod-clair-templates.s3.eu-west-1.amazonaws.com/images/agency-client-portal.png",
        },
      },
    },
  })
