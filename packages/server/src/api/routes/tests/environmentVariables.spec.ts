...
import { mocks } from "@clairview/backend-core/tests"
import { env, events } from "@clairview/backend-core"
import { QueryPreview } from "@clairview/types"

const structures = setup.structures

env._set("ENCRYPTION_KEY", "clairview")
