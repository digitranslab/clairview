<script>
  import ClientAppSkeleton from "@clairview/frontend-core/src/components/ClientAppSkeleton.svelte"
...
<svelte:head>
  ...
  <!-- Opengraph Meta Tags -->
  <meta property="og:site_name" content="Clairview" />
  ...
  <meta property="twitter:site" content="@clairview" />
...
<body id="app">
  ...
  <div id="error">
    {#if clientLibPath}
      ...
      <h2>
        The Clairview client library could not be loaded. Try republishing your
        app.
      </h2>
    {:else}
  ...
  <!-- But before loadClairview is called -->
  ...
  <script type="application/javascript" {nonce}>
    if (window.loadClairview) {
      ...
      console.error("Failed to load the Clairview client")
