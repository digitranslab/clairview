...
import { users as userCore, db as dbCore } from "@clairview/backend-core"
...
export async function fetch(ctx: Ctx) {
  ...
  // **** clairview_tenant_production_app_count ****
  outputString += convertToOpenMetrics(
    "clairview_tenant_production_app_count",
  ...
  // **** clairview_tenant_dev_app_count ****
  outputString += convertToOpenMetrics(
    "clairview_tenant_dev_app_count",
  ...
  // **** clairview_quota_usage_user_groups ****
  outputString += convertToOpenMetrics(
    "clairview_quota_usage_user_groups",
  ...
  // **** clairview_quota_limit_user_groups ****
  outputString += convertToOpenMetrics(
    "clairview_quota_limit_user_groups",
  ...
  // **** clairview_quota_usage_automations ****
  outputString += convertToOpenMetrics(
    "clairview_quota_usage_automations",
  ...
  // **** clairview_quota_limit_automations ****
  outputString += convertToOpenMetrics(
    "clairview_quota_limit_automations",
