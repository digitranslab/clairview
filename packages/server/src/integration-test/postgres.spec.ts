import { Datasource, FieldType, Table } from "@clairview/types"
    ...
    ({ config, dsProvider }) => {
      ...
      describe("check fetching null/not null table", () => {
        ...
        it("should be able to change the table to allow nullable and refetch this", async () => {
          ...
          // need to perform these calls raw to the DB so that the external state of the DB differs to what Clairview
