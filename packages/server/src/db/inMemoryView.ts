import { Row, Document, DBView } from "@clairview/types"

// bypass the main application db config
// use in memory pouchdb directly
import { db as dbCore, utils } from "@clairview/backend-core"
...
export async function runView(
  ...
  try {
    ...
    // CLAIR-7060 -> indirect eval call appears to cause issues in cloud
