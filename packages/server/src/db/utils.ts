import { context, db as dbCore, docIds, utils } from "@clairview/backend-core"
import {
  DatabaseQueryOpts,
  Datasource,
  DocumentType,
...
export { DocumentType, VirtualDocumentType } from "@clairview/types"
...
export const ClairviewInternalDB: Datasource = {
