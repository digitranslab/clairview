...
import { processStringSync, encodeJSBinding } from "@clairview/string-templates"

import { runJsHelpersTests } from "@clairview/string-templates/test/utils"
...
describe("jsRunner (using isolated-vm)", () => {
  ...
  // the test cases here were extracted from templates/real world examples of JS in Clairview
  describe("real test cases from Claircloud", () => {
    const context = {
      "Unit Value": 2,
      Quantity: 1,
    }
