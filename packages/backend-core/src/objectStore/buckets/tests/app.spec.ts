...
describe("app", () => {
  ...
  describe("clientLibraryUrl", () => {
    function getClientUrl() {
      return app.clientLibraryUrl("app_123/clairview-client.js", "2.0.0")
    }
  ...
  describe("getAppFileUrl", () => {
    ...
    describe("single tenant", () => {
      ...
      it("gets url with embedded minio", () => {
        ...
        expect(url).toBe(
          "/files/signed/prod-clair-app-assets/app_123/attachments/image.jpeg"
        )
      })
      ...
      it("gets url with custom S3", () => {
        ...
        const url = getAppFileUrl()
        expect(url).toBe(
          "http://s3.example.com/prod-clair-app-assets/app_123/attachments/image.jpeg"
        )
      })
