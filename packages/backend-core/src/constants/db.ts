import { prefixed, DocumentType } from "@clairview/types"
...
export const CLAIRVIEW_DATASOURCE_TYPE = "clairview"
...
export { DEFAULT_BB_DATASOURCE_ID } from "@clairview/shared-core"
