  ...
  it("should generate a nonce and set it in the script-src directive", async () => {
    ...
    expect(ctx.set).toHaveBeenCalledWith(
      ...
      expect.stringContaining(
        `script-src 'self' 'unsafe-eval' https://*.clairview.net https://cdn.clair.live https://js.intercomcdn.com https://widget.intercom.io https://d2l5prqdbvm3op.cloudfront.net https://us-assets.i.posthog.com 'nonce-${mockNonce}'`
      )
    )
