...
import { getImageAbsoluteURI } from 'clairview-shared';
...
// TODO: Remove recoil because we don't want it into clairview-ui and find a solution for invalid avatar urls
export const Avatar = ({
  avatarUrl,
  size = 'md',
  placeholder,
