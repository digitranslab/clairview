...
export enum BpmCorrelationKey {
  ONBOARDING = "clairview:onboarding:correlationkey",
  VERIFY_SSO_LOGIN = "clairview:verify_sso_login:correlationkey",
}

export enum BpmInstanceKey {
  ONBOARDING = "clairview:onboarding:instancekey",
  VERIFY_SSO_LOGIN = "clairview:verify_sso_login:instancekey",
}

export enum BpmStatusKey {
  ONBOARDING = "clairview:onboarding:status",
  VERIFY_SSO_LOGIN = "clairview:verify_sso_login:status",
}
