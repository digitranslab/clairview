jest.mock("@clairview/handlebars-helpers/lib/math", () => {
  const actual = jest.requireActual("@clairview/handlebars-helpers/lib/math")
...
jest.mock("@clairview/handlebars-helpers/lib/uuid", () => {
  const actual = jest.requireActual("@clairview/handlebars-helpers/lib/uuid")
