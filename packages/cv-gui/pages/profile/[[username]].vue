      ...
      <a-layout class="h-[75vh] overflow-y-auto flex">
        <a-layout-sider :collapsed="false" width="320" class="h-max px-5" :trigger="null" collapsible theme="light">
          <div class="mx-2">
            ...
            <div class="cv-profile-display-name text-[30px] my-2 font-bold">
              {{ profile.display_name }}
            </div>

            <div class="cv-profile-user-name text-[18px] my-2">@{{ profile.user_name }}</div>

            <div class="cv-profile-bio text-[15px] my-4">
              {{ profile.bio }}
            </div>

            <div class="cv-profile-follower my-2">
            ...
            <div v-if="profile.id !== user.id" class="cv-profile-follow-btn my-4">
              <a-button
                v-if="!isFollowing"
            ...
            <div class="cv-profile-statistics my-10">
              ...
              <div class="mt-5">
                ...
                <div class="mt-2">
                  <div class="cv-profile-statistics-badge inline-block m-1">
