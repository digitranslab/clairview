    ...
    <NuxtLayout name="empty">
      <div class="mx-auto h-full">
        <div class="h-full flex">
          ...
          <div class="h-full bg-white cv-user-sidebar overflow-y-auto cv-scrollbar-thin min-w-[312px]">
            <NcMenu
            ...
            >
              <div class="h-[var(--topbar-height)] flex items-center children:flex-none">
                <NcButton
                  ...
                  type="text"
                  size="small"
                  class="transition-all duration-200 mx-2 cursor-pointer transform hover:bg-gray-100 cv-noco-brand-icon"
              ...
              >
                <div class="flex items-center space-x-2 w-full">
                  ...
                  <NcTooltip v-if="isPending">
                    ...
                    <GeneralIcon icon="ncAlertCircle" class="text-orange-500 w-4 h-4 cv-pending" />
                  </NcTooltip>
                </div>
              </NcMenuItem>
          ...
          <div class="h-full flex-1 flex flex-col overflow-y-auto cv-scrollbar-thin">
            <div class="flex flex-row pt-2 px-2 items-center">
              ...
              <template v-if="signedIn">
                <NcDropdown :trigger="['click']" overlay-class-name="cv-dropdown-user-accounts-menu">
                  <NcButton type="text" size="small">
                    <component
                      :is="iconMap.threeDotVertical"
                      data-testid="cv-menu-accounts"
                      class="md:text-lg cursor-pointer hover:text-gray-800 cv-menu-accounts"
                      @click.prevent
                    />
                  </NcButton>
                  ...
                  <template #overlay>
                    <div class="!py-1 !rounded-md bg-white overflow-hidden">
                      <div class="!rounded-b group" data-testid="cv-menu-accounts__sign-out">
                        <div v-e="['a:navbar:user:sign-out']" class="cv-account-dropdown-item group" @click="logout">
...
:deep(.cv-user-sidebar .ant-menu-sub.ant-menu-inline) {
  @apply bg-transparent;
}

:deep(.cv-user-sidebar .ant-menu-item-only-child),
