...
import { validatePassword } from 'clairview-sdk'
    ...
    <NuxtLayout>
      <div class="md:bg-primary bg-opacity-5 signup h-full min-h-[600px] flex flex-col justify-center items-center">
        ...
        <div class="prose-sm mt-4 text-gray-500">
          {{ $t('msg.bySigningUp') }}
          <a class="prose-sm !text-gray-500 underline" target="_blank" href="https://clairview.com/policy-clairview" rel="noopener">
