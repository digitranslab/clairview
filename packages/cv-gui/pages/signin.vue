...
<template>
  <div>
    <NuxtLayout>
      <div
        data-testid="cv-form-signin"
        class="md:bg-primary bg-opacity-5 signin h-full min-h-[600px] flex flex-col justify-center items-center cv-form-signin"
      >
        <div
        ...
        >
          ...
          <a-form ref="formValidator" :model="form" layout="vertical" no-style @finish="signIn">
            <template v-if="!appInfo.disableEmailAuth">
              ...
              <a-form-item :label="$t('labels.password')" name="password" :rules="formRules.password">
                <a-input-password
                  ...
                  data-testid="cv-form-signin__password"
                  size="large"
                  class="password"
            ...
            <div class="self-center flex flex-col flex-wrap gap-4 items-center mt-4 justify-center">
              <template v-if="!appInfo.disableEmailAuth">
                <button data-testid="cv-form-signin__submit" class="scaling-btn bg-opacity-100" type="submit">
