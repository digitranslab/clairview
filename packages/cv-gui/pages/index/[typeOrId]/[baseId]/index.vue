...
const { toggle, toggleHasSidebar } = useSidebar('cv-left-sidebar', { hasSidebar: true, isOpen: true })
...
:global(#cv-sidebar-left .ant-layout-sider-collapsed) {
  @apply !w-0 !max-w-0 !min-w-0 overflow-x-hidden;
}

.cv-left-sidebar {
  .cv-sidebar-left-toggle-icon {
  ...
  &:hover .cv-sidebar-left-toggle-icon {
    @apply opacity-100;
  }
}
