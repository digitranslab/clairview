...
import { RelationTypes, UITypes, isVirtualCol } from 'clairview-sdk'
import { ref } from 'vue'
      ...
      <template v-if="sharedFormView">
        ...
        <template v-else-if="submitted">
          <div class="flex justify-center">
            <div v-if="sharedFormView" class="w-full">
              <a-alert class="cv-shared-form-success-msg !mt-2 !mb-4 !py-4 text-left !rounded-lg" type="success" outlined>
                <template #message>
                  <LazyCellRichText
        ...
        <template v-else>
          <a-modal
            ...
            centered
            :footer="null"
            wrap-class-name="cv-modal-generate-token"
            destroy-on-close
          ...
          <div class="cv-form-wrapper">
            <a-form :model="formState">
              <div class="cv-form h-full">
                <div class="flex flex-col gap-3 md:gap-6">
                  <div
                    v-for="(field, index) in formColumns"
                    :key="index"
                    class="flex flex-col gap-2"
                    :data-testid="`cv-shared-form-item-${field.title?.replace(' ', '')}`"
                  >
                    <div class="cv-form-column-label text-sm font-semibold text-gray-800">
                      <span>
                        {{ field.label || field.title }}
                      </span>
                      <span v-if="isRequired(field, field.required)" class="text-red-500 text-base leading-[18px]">&nbsp;*</span>
                    </div>
                    <div v-if="field?.description" class="cv-form-column-description text-gray-500 text-sm">
                      <LazyCellRichText
                        ...
                        >
                          <LazySmartsheetDivDataCell class="flex relative">
                            <LazySmartsheetVirtualCell
                              ...
                              :data-testid="`cv-form-input-cell-${field.label || field.title}`"
                            ...
                            <LazySmartsheetCell
                              ...
                              :data-testid="`cv-form-input-cell-${field.label || field.title}`"
                              :class="[
                                `cv-form-input-${field.title?.replaceAll(' ', '')}`,
                            ...
                            <a-button
                              ...
                              class="cv-btn-fill-form-column-by-scan cv-toolbar-btn"
                ...
                <div class="flex justify-between items-center mt-6">
                  <NcButton
                    ...
                    :size="isMobileMode ? 'medium' : 'small'"
                    :disabled="isLoading"
                    class="cv-shared-form-button shared-form-clear-button"
                  ...
                  <NcButton
                    ...
                    type="primary"
                    :size="isMobileMode ? 'medium' : 'small'"
                    class="cv-shared-form-button shared-form-submit-button"
...
.cv-btn-fill-form-column-by-scan {
  @apply h-auto;
  @apply ml-1;
}

.cv-shared-form-button {
  &.cv-button.ant-btn:focus {
