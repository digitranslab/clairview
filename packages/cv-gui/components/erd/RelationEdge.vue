...
<template>
  ...
  <EdgeLabelRenderer>
    <div
      ...
      :class="[
        ...
        `cv-erd-table-label-${data.label.toLowerCase().replace(' ', '-').replace('\(', '').replace(')', '')}`,
      ]"
    >
  ...
  <template v-if="!showSkeleton">
    ...
    />
    <circle v-else class="cv-erd-edge-circle" :cx="targetX" :cy="targetY" fill="#fff" :r="5" stroke="#898E99" :stroke-width="2" />
  </template>
</template>
