...
import type { LinkToAnotherRecordType, SourceType, TableType } from 'clairview-sdk'
import { isLinksOrLTAR } from 'clairview-sdk'
...
<template>
  <div
    ...
    :class="{
      ...
      'cv-erd-vue-flow-single-table': config.singleTableMode,
      'cv-erd-vue-flow': !config.singleTableMode,
    }"
