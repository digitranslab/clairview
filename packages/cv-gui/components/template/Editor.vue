...
import type { ColumnType, OracleUi, TableType } from 'clairview-sdk'
import {
  SqlUiFactory,
  UITypes,
  getDateFormat,
              ...
              <template #bodyCell="{ column, record }">
                ...
                <template v-else-if="column.key === 'destination_column'">
                  <a-select
                    ...
                    dropdown-class-name="cv-dropdown-filter-field"
                  >
                    <template #suffixIcon>
                ...
                <template #bodyCell="{ column, record }">
                  <template v-if="column.key === 'column_name'">
                    <a-form-item
                      ...
                      class="cv-table-field-name !mb-0 w-full"
                    >
                      <a-input
                    ...
                    <a-form-item v-bind="validateInfos[`tables.${tableIdx}.columns.${record.key}.uidt`]" class="!mb-0 w-full">
                      <NcTooltip :disabled="importDataOnly">
                        ...
                        <a-select
                          ...
                          show-search
                          :filter-option="filterOption"
                          dropdown-class-name="cv-dropdown-template-uidt"
