...
const overlayClassName = computed(() => {
  if (alignLeftLevel.value === 1) return 'cv-view-create-dropdown cv-view-create-dropdown-left-1'

  if (alignLeftLevel.value === 2) return 'cv-view-create-dropdown cv-view-create-dropdown-left-2'

  return 'cv-view-create-dropdown'
})
 ...
 *
 * @see {@link packages/cv-gui/components/smartsheet/topbar/ViewListDropdown.vue} for a similar implementation of view creation dialog.
...
<style lang="scss">
.cv-view-create-dropdown {
  @apply !max-w-43 !min-w-43;
}

.cv-view-create-dropdown-left-1 {
  @apply !left-18;
}

.cv-view-create-dropdown-left-2 {
  @apply !left-23.5;
}
</style>
