...
<template>
  <a-menu
    ...
    class="cv-views-menu flex flex-col w-full !border-r-0 !bg-inherit"
  >
    <template v-if="!isSharedBase">
      ...
      >
        <div
          ...
          class="cv-create-view-btn flex flex-row items-center cursor-pointer rounded-md w-full"
          role="button"
        >
    ...
    <template v-if="views.length">
      <DashboardTreeViewViewsNode
        ...
        :class="{
          ...
          [`cv-${view.type ? viewTypeAlias[view.type] : undefined || view.type}-view-item`]: true,
        }"
        :data-view-id="view.id"
        :on-validate="validate"
        :table="table"
        :view="view"
        class="cv-view-item !rounded-md !px-0.75 !py-0.5 w-full transition-all ease-in duration-100"
