...
import { ProjectRoles, RoleColors, RoleIcons, RoleLabels, WorkspaceRolesToProjectRoles, stringifyRolesObj } from 'clairview-sdk'
import type { BaseType, SourceType, TableType, WorkspaceUserRoles } from 'clairview-sdk'
 ...
 *
 * @see {@link packages/cv-gui/components/smartsheet/topbar/TableListDropdown.vue} for a similar implementation
...
<template>
  <NcDropdown :trigger="['contextmenu']" overlay-class-name="cv-dropdown-tree-view-context-menu">
    <div
      ref="labelEl"
      class="mx-1 cv-base-sub-menu rounded-md"
      :class="{ active: base.isExpanded }"
      :data-testid="`cv-sidebar-base-${base.title}`"
      ...
      >
        ...
        <div class="flex items-center gap-0.75 py-0.5 cursor-pointer" @contextmenu="setMenuContext('base', base)">
          <div
            ...
            :data-id="base.id"
            :data-testid="`cv-sidebar-base-title-${base.title}`"
            class="cv-sidebar-node base-title-node h-7 flex-grow rounded-md group flex items-center w-full pr-1 pl-1.5"
          >
            <div
            ...
            <NcTooltip
              ...
              class="cv-sidebar-node-title capitalize text-ellipsis overflow-hidden select-none flex-1"
            ...
            <template v-if="!editMode">
              <NcDropdown v-if="!isSharedBase" v-model:visible="isOptionsOpen" :trigger="['click']">
                <NcButton
                  v-e="['c:base:options']"
                  class="cv-sidebar-node-btn"
                  :class="{ '!text-black !opacity-100 !inline-block': isOptionsOpen }"
                  data-testid="cv-sidebar-context-menu"
                  type="text"
                  size="xxsmall"
                  @click.stop
                  @mouseenter="showNodeTooltip = false"
                ...
                <template #overlay>
                  <NcMenu
                    class="cv-scrollbar-md"
                    :style="{
                      maxHeight: '70vh',
                      overflow: 'overlay',
                    }"
                    :data-testid="`cv-sidebar-base-${base.title}-options`"
                    @click="isOptionsOpen = false"
                  >
                    <template v-if="!isSharedBase">
                      <NcMenuItem
                        v-if="isUIAllowed('baseRename')"
                        data-testid="cv-sidebar-project-rename"
                      ...
                      <NcMenuItem
                        ...
                        data-testid="cv-sidebar-base-duplicate"
                      ...
                      <NcMenuItem
                        v-if="!isEeUI"
                        key="copy"
                        data-testid="cv-sidebar-base-copy-base-info"
                      ...
                      <NcMenuItem
                        ...
                        key="erd"
                        data-testid="cv-sidebar-base-relations"
                      ...
                      <NcMenuItem
                        ...
                        key="api"
                        data-testid="cv-sidebar-base-rest-apis"
                        @click.stop="
                          () => {
                            $e('c:base:api-docs')
                    ...
                    <NcMenuItem
                      ...
                      key="teamAndSettings"
                      data-testid="cv-sidebar-base-settings"
                      class="cv-sidebar-base-base-settings"
                    ...
                    <NcMenuItem
                      ...
                      data-testid="cv-sidebar-base-delete"
              ...
              <NcButton
                ...
                size="xxsmall"
                type="text"
                data-testid="cv-sidebar-add-base-entity"
                :class="{
              ...
              <NcButton
                ...
                type="text"
                size="xxsmall"
                class="cv-sidebar-node-btn cv-sidebar-expand !xs:opacity-100 !mr-0 mt-0.5"
                :class="{
              ...
              <div class="border-none sortable-list">
                <div v-for="(source, sourceIndex) of base.sources" :key="`source-${source.id}`">
                  ...
                  <a-collapse
                    ...
                    class="!mx-0 !px-0 cv-sidebar-source-node"
                    ...
                    <a-collapse-panel :key="`collapse-${source.id}`">
                      <template #header>
                        <div
                          ...
                          class="cv-sidebar-node min-w-20 w-full h-full flex flex-row group py-0.5 !mr-0"
                          :class="{
                        ...
                        >
                          <div
                            v-if="sourceIndex === 0"
                            class="source-context flex items-center gap-2 text-gray-800 cv-sidebar-node-title"
                          ...
                          >
                            ...
                            <NcTooltip
                              v-else
                              class="cv-sidebar-node-title capitalize text-ellipsis overflow-hidden select-none text-gray-700"
                              :style="{ wordBreak: 'keep-all', whiteSpace: 'nowrap', display: 'inline' }"
                              show-on-truncate-only
                            >
                              <template #title> {{ source.alias || '' }}</template>
                              <span :data-testid="`cv-sidebar-base-${source.alias}`">
                                {{ source.alias || '' }}
                              </span>
                            </NcTooltip>
                          </div>
                            ...
                            >
                              ...
                              <template #overlay>
                                ...
                                >
                                  <NcMenuItem
                                    v-if="isUIAllowed('baseRename')"
                                    data-testid="cv-sidebar-source-rename"
      ...
      >
        ...
        <template v-else-if="contextMenuTarget.type === 'table'">
          ...
          >
            ...
            >
              <div v-e="['c:table:rename']" class="cv-base-option-item flex gap-2 items-center">
            ...
            >
              <div v-e="['c:table:duplicate']" class="cv-base-option-item flex gap-2 items-center">
                <GeneralIcon icon="duplicate" class="text-gray-700" />
            ...
            <NcMenuItem
              ...
              @click="tableDelete"
            >
              <div class="cv-base-option-item flex gap-2 items-center text-red-600">
