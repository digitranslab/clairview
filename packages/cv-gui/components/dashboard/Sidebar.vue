...
<template>
  <div
    class="cv-sidebar flex flex-col bg-gray-50 outline-r-1 outline-gray-100 select-none w-full h-full"
    :style="{
      outlineWidth: '1px',
    }"
  >
    ...
    <div
      ref="treeViewDom"
      class="flex flex-col cv-scrollbar-dark-md flex-grow xs:(border-transparent pt-2 pr-2)"
      :class="{
