...
const customRow = (record: Record<string, any>) => ({
  class: `cv-metasync-row cv-metasync-row-${record.table_name}`,
})
</script>
  ...
  <div class="h-full flex flex-col w-full">
    <div class="h-full flex flex-col">
      <div class="flex flex-row justify-between items-center w-full mb-4">
        <div class="flex">
          <div v-if="isDifferent">
            <a-button v-e="['a:proj-meta:meta-data:sync']" class="cv-btn-metasync-sync-now" type="primary" @click="syncMetaDiff">
        ...
        <a-button
          ...
          class="self-start !rounded-md cv-btn-metasync-reload"
          @click="loadMetaDiff"
        >
      ...
      <NcTable
        ...
        class="cv-metasync-table h-[calc(100%_-_58px)] w-full"
      >
