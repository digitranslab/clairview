...
import type { SourceType } from 'clairview-sdk'
...
<template>
  <div class="flex flex-col h-full p-6" data-testid="cv-settings-datasources-tab">
    <div class="mb-6 flex items-center justify-between gap-3">
      <a-input
        v-model:value="searchQuery"
        type="text"
        class="cv-search-data-source-input !max-w-90 cv-input-sm"
    ...
    <div
      data-testid="cv-settings-datasources"
      class="flex flex-row w-full cv-data-sources-view flex-grow min-h-0"
      :style="{
    ...
    >
      <NcModal
        ...
        centered
        size="large"
        wrap-class-name="cv-active-data-sources-view"
      ...
      >
        <div v-if="activeSource" class="h-full">
          <div class="px-4 pt-4 pb-2 flex items-center justify-between gap-3">
            ...
            <NcButton size="small" type="text" class="cv-close-btn" @click="isOpenModal = false">
              <GeneralIcon icon="close" class="text-gray-600" />
            </NcButton>
          </div>

          <NcTabs v-model:activeKey="openedTab" class="cv-source-tab w-full h-[calc(100%_-_58px)] max-h-[calc(100%_-_58px)]">
            <a-tab-pane v-if="!activeSource.is_meta && !activeSource.is_local" key="edit">
              <template #tab>
                <div class="tab" data-testid="cv-connection-tab">
            ...
            <a-tab-pane key="erd">
              <template #tab>
                <div class="tab" data-testid="cv-erd-tab">
            ...
            <a-tab-pane v-if="isEeUI && sources && activeSource === sources[0]" key="audit">
              <template #tab>
                <div class="tab" data-testid="cv-audit-tab">
            ...
            <a-tab-pane key="acl">
              <template #tab>
                <div class="tab" data-testid="cv-acl-tab">
            ...
            <a-tab-pane v-if="!activeSource.is_meta && !activeSource.is_local" key="meta-sync">
              <template #tab>
                <div class="tab" data-testid="cv-meta-sync-tab">
      ...
      >
        ...
        <div v-else class="ds-table overflow-y-auto cv-scrollbar-thin relative max-h-full mb-4">
                ...
                >
                  ...
                  <div class="ds-table-col ds-table-actions">
                    <NcButton
                      ...
                      size="small"
                      class="cv-action-btn cv-edit-base cursor-pointer outline-0 !w-8 !px-1 !rounded-lg"
                      type="text"
