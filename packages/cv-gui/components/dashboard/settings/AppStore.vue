...
<template>
  <div>
    <a-modal
      ...
      min-height="300"
      :footer="null"
      wrap-class-name="cv-modal-plugin-install"
      v-bind="$attrs"
    >
    ...
    <a-modal
      ...
      centered
      :footer="null"
      wrap-class-name="cv-modal-plugin-uninstall"
    >
    ...
    <div class="flex flex-wrap w-full gap-5">
      <a-card
        ...
        :class="`relative flex overflow-x-hidden app-item-card !shadow-sm rounded-md w-full cv-app-store-card-${app.title}`"
      >
        <div class="install-btn flex flex-row justify-end space-x-1">
          <a-button v-if="app.parsedInput" size="small" type="primary" @click="showInstallPluginModal(app)">
            <div class="flex flex-row justify-center items-center caption capitalize cv-app-store-card-edit">
          ...
          <a-button v-if="app.parsedInput" size="small" outlined @click="showResetPluginModal(app)">
            <div class="flex flex-row justify-center items-center caption capitalize cv-app-store-card-reset">
          ...
          <a-button v-else size="small" type="primary" @click="showInstallPluginModal(app)">
            <div class="flex flex-row justify-center items-center caption capitalize cv-app-store-card-install">
