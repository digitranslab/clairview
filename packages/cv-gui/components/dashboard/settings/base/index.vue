...
<template>
  <div class="flex p-5 cv-base-settings justify-center overflow-auto gap-8">
    <!-- Left Pane -->
    <div v-if="isEeUI" class="flex flex-col">
      <div class="h-full w-60">
        <div
          ...
          class="gap-3 !hover:bg-gray-50 transition-all text-cv-content-gray flex rounded-lg items-center cursor-pointer py-1.5 px-3"
...
.active-menu {
  @apply !bg-brand-50 font-semibold !text-cv-content-brand-disabled;
}
</style>
