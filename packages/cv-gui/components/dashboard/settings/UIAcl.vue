    ...
    <div class="w-full h-full flex flex-col">
      ...
      <div class="flex flex-row items-center w-full mb-4 gap-2 justify-between">
        <a-input
          ...
          allow-clear
          class="cv-acl-search cv-input-border-on-value !w-[400px] cv-input-sm"
        >
          <template #prefix>
        ...
        <div class="flex">
          <a-button type="text" ghost class="self-start !rounded-md cv-acl-reload" @click="loadTableList">
            ...
            <div>
              <NcTooltip>
                ...
                <NcCheckbox
                  ...
                  :class="`cv-acl-${record.title}-${column.name}-chkbox !ml-0.25`"
