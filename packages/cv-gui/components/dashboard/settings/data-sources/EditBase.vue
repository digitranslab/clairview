...
import { type SourceType, validateAndExtractSSLProp } from 'clairview-sdk'
...
<template>
  <div class="edit-source bg-white relative h-full flex flex-col w-full">
    <div class="h-full max-h-[calc(100%_-_65px)] flex">
      <div class="cv-edit-source-left-panel cv-scrollbar-thin relative">
                ...
                <a-row :gutter="24">
                  <a-col :span="12">
                    <a-form-item label="Data Source Name" v-bind="validateInfos.title">
                      <a-input v-model:value="formState.title" class="cv-extdb-proj-name" />
                    </a-form-item>
                  </a-col>
                </a-row>
                <a-row :gutter="24">
      ...
      <div class="cv-edit-source-right-panel">
...
.cv-edit-source-left-panel {
  @apply p-6 flex-1 flex justify-center;
}
.cv-edit-source-right-panel {
