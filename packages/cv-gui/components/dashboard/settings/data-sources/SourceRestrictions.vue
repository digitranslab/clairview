...
<template>
  <a-form-item class="cv-source-restictions-card">
    <div class="flex flex-col gap-1">
      <div class="flex items-center gap-3">
        <NcTooltip :disabled="!metaWrite" placement="topLeft" class="flex">
          ...
          <a-switch v-model:checked="dataWrite" :disabled="metaWrite" data-testid="cv-allow-data-write" size="small"></a-switch>
        </NcTooltip>
    ...
    <div class="flex flex-col gap-1">
      <div class="flex items-center gap-3">
        <a-switch
          ...
          data-testid="cv-allow-meta-write"
          class="cv-allow-meta-write"
          size="small"
        ></a-switch>
      ...
      <div class="ml-10 text-small leading-[18px] text-gray-500" :class="{ 'cv-allow-meta-write-help': metaWrite }">
...
.cv-allow-meta-write.ant-switch-checked {
  background: #b33771;
}

.cv-allow-meta-write-help {
  color: #b33771;
}

.cv-source-restictions-card {
