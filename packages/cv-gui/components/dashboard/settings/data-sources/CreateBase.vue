...
import { type IntegrationType, validateAndExtractSSLProp } from 'clairview-sdk'
import {
  ClientType,
...
const handleUpdateAdvancedOptionsExpansionPanel = (open: boolean) => {
  if (open) {
    ...
    handleAutoScroll(true, 'cv-source-advanced-options')
  } else {
...
<template>
  <NcModal
    ...
    centered
    size="large"
    wrap-class-name="cv-modal-create-source"
  ...
  >
    <div class="flex-1 flex flex-col max-h-full">
      ...
      <div class="h-[calc(100%_-_58px)] flex">
        <div class="cv-add-source-left-panel cv-scrollbar-thin relative">
          <div class="create-source bg-white relative flex flex-col gap-2 w-full max-w-[768px]">
            ...
            >
                    ...
                    <a-col :span="12">
                      <a-form-item label="Select connection" v-bind="validateInfos.fk_integration_id">
                        <NcSelect
                          ...
                          class="cv-extdb-db-type cv-select-shadow"
              ...
              <template v-if="selectedIntegration">
                ...
                <div class="cv-form-section">
                  <div class="cv-form-section-title">Permissions</div>
                  <div class="cv-form-section-body">
                ...
                >
                  <a-collapse v-model:active-key="advancedOptionsExpansionPanel" ghost class="cv-source-advanced-options !mt-4">
                            ...
                            <a-col :span="12">
                              <a-form-item :label="$t('labels.inflection.tableName')">
                                <NcSelect
                                  ...
                                  dropdown-class-name="cv-dropdown-inflection-table-name"
                                >
                            ...
                            <a-col :span="12">
                              <a-form-item :label="$t('labels.inflection.columnName')">
                                <NcSelect
                                  ...
                                  class="cv-select-shadow"
                                  dropdown-class-name="cv-dropdown-inflection-column-name"
                                >
                                  <a-select-option v-for="tp in inflectionTypes" :key="tp" :value="tp">{{ tp }}</a-select-option>
                                </NcSelect>
                              </a-form-item>
        ...
        <div class="cv-add-source-right-panel">
...
.cv-add-source-left-panel {
  @apply p-6 flex-1 flex justify-center;
}
.cv-add-source-right-panel {
