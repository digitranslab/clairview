...
<template>
  ...
  >
    ...
    >
      ...
      <div v-if="isNewFeedAvailable" class="w-3 h-3 pulsing-dot bg-cv-fill-red-medium border-2 border-white rounded-full"></div>
    </div>
  </NcButton>
</template>
