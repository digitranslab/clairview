...
<template>
  <div
    class="flex items-center cv-sidebar-header w-full border-b-1 border-gray-200 group md:(px-2 py-1.2) xs:(px-1 py-1)"
    ...
    <div v-if="!isWorkspaceLoading" class="flex flex-row items-center w-full">
      ...
      >
        ...
        <NcButton
          ...
          class="cv-sidebar-left-toggle-icon !text-gray-700 !hover:text-gray-800 !xs:(h-10.5 max-h-10.5 max-w-10.5) !md:(hover:bg-gray-200)"
