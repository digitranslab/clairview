  ...
  <template v-else-if="!isSharedBase">
    <div class="xs:hidden flex flex-col p-1 mt-0.25 mb-0.5 truncate">
      ...
      <NcButton
        ...
        type="text"
        size="xsmall"
        class="cv-sidebar-top-button !xs:hidden my-0.5 !h-7"
        data-testid="cv-sidebar-team-settings-btn"
        :centered="false"
        :class="{
      ...
      <NcButton
        ...
        size="xsmall"
        class="cv-sidebar-top-button !xs:hidden my-0.5 !h-7"
        data-testid="cv-sidebar-integrations-btn"
        :centered="false"
        :class="{
      ...
      <WorkspaceCreateProjectBtn
        ...
        modal
        type="text"
        class="cv-sidebar-top-button !hover:(bg-gray-200 text-gray-700) !xs:hidden !h-7 my-0.5"
        data-testid="cv-sidebar-create-base-btn"
      >
