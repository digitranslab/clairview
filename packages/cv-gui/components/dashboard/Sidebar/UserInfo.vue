    ...
    <div class="flex items-center pr-2 justify-between">
      <NcDropdown v-model:visible="isMenuOpen" placement="topLeft" overlay-class-name="!min-w-64">
        <div
          ...
          data-testid="cv-sidebar-userinfo"
        >
        ...
        <template #overlay>
          <NcMenu data-testid="cv-sidebar-userinfo">
            <NcMenuItem data-testid="cv-sidebar-user-logout" @click="logout">
            ...
            <a
              v-e="['c:clairview:reddit']"
              href="https://www.reddit.com/r/ClairView"
              target="_blank"
              class="!underline-transparent"
              rel="noopener noreferrer"
            >
              ...
              <a-popover key="language" class="lang-menu !py-1.5" placement="rightBottom">
                <NcMenuItem>
                  <div v-e="['c:translate:open']" class="flex gap-2 items-center">
                    <GeneralIcon icon="translate" class="group-hover:text-black cv-language ml-0.25 menu-icon" />
                    {{ $t('labels.language') }}
