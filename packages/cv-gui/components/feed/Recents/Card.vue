...
const expand = () => {
  ...
  $e('c:clairview:feed:recents:expand', {
    title: Title,
    type: source,
  })
}
...
const watchVideo = () => {
  $e('c:clairview:feed:recents:watch', {
    title: Title,
  ...
  <div class="bg-white recent-card border-gray-200 border-1 rounded-2xl max-w-[540px] xl:max-w-[640px]">
    <div class="flex items-center justify-between px-5 py-4">
      <div class="flex items-center gap-3">
        ...
        <span class="font-weight-medium text-cv-content-gray leading-5 cursor-pointer" @click="handleOpenUrl(Url)">
          {{ source }}
        </span>
      </div>
      <div class="text-sm text-cv-content-gray-muted leading-5">
        {{ timeAgo(CreatedAt) }}
      </div>
    </div>
    ...
    <template v-else-if="source === 'Youtube'">
      <YoutubeVue3
        ...
        @played="watchVideo"
      />
      <div class="p-5 flex flex-col text-cv-content-gray-emphasis gap-4">
...
.recent-card {
  ...
  :deep(.prose) {
    ...
    h1 {
      @apply text-3xl text-cv-content-gray-emphasis truncate leading-9 mb-0;
      font-weight: 700;
    }

    h2 {
      @apply text-cv-content-gray-emphasis text-xl leading-6 !mb-0;
    }
    p {
      @apply text-cv-content-gray-emphasis leading-6;
    ...
    h3 {
      @apply text-cv-content-gray-emphasis text-lg leading-6 mb-0;
    }
  }
}
</style>
