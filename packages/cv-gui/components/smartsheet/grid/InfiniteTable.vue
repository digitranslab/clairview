...
<template>
  <div class="flex flex-col h-full w-full">
    ...
    <div ref="gridWrapper" class="cv-grid-wrapper min-h-0 flex-1 relative !overflow-auto">
      <NcDropdown
          ...
          >
            <thead ref="tableHeadEl">
              ...
              <tr
                ...
                class="cv-grid-header transform"
              >
                <th
                  ref="numColHeader"
                ...
                >
                  ...
                  <template v-else>
                    <div class="w-full h-full text-gray-500 flex pl-2 pr-1 items-center" data-testid="cv-check-all">#</div>
                  </template>
                </th>
                <th
                  v-if="fields?.[0]?.id"
              ...
              >
                ...
                >
                  <template #default="{ state }">
                    ...
                    <tr
                      class="cv-grid-row transition transition-opacity duration-500 opacity-100 !xs:h-14"
                      :style="{
                        height: `${rowHeight}px`,
                      }"
                    ...
                    >
                      ...
                      >
                        <div class="w-[60px] pl-2 pr-1 items-center flex gap-1">
                          ...
                          <div
                            class="cv-expand"
                            :data-testid="`cv-expand-${row.rowMeta.rowIndex}`"
                          ...
                          >
                            ...
                            >
                              <component
                                ...
                                class="select-none transform cv-row-expand opacity-90 w-4 h-4"
                                @click="expandAndLooseFocus(row, state)"
                              />
                            </div>
                          </div>
                ...
                <tr
                  ...
                  class="text-left cv-grid-add-new-cell mb-64 transition-all cursor-pointer group relative z-3 xs:hidden"
                  :class="{
...
.cv-grid-wrapper {
  ...
  tbody td:not(.placeholder-column):not(.cv-grid-add-new-cell-item):nth-child(1) {
    position: sticky !important;
    left: 0;
    z-index: 4;
    background: white;
  ...
  .desktop {
    ...
    tbody tr:not(.cv-grid-add-new-cell):not(.placeholder) td:not(.placeholder-column):nth-child(2) {
      position: sticky !important;
      z-index: 4;
      left: 64px;
      background: white;
    ...
    tbody {
      tr:not(.cv-grid-add-new-cell):not(.placeholder) td:nth-child(3) {
        &.active-cell {
      ...
      tr:not(.cv-grid-add-new-cell):not(.placeholder):nth-child(1) td {
        &.active-cell {
      ...
      tr:not(.cv-grid-add-new-cell):not(.placeholder):nth-last-child(2) td {
        &.active-cell {
  ...
  .cv-grid-skeleton-loader {
    ...
    tbody td:not(.placeholder-column):not(.cv-grid-add-new-cell-item):nth-child(2) {
      @apply border-r-1 !border-r-gray-50;
    }
  }
}
