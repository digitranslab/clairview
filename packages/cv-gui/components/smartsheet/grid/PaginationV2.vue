...
import { type PaginatedType, UITypes } from 'clairview-sdk'
  ...
  <div ref="containerElement" class="bg-gray-50 w-full pr-1 border-t-1 border-gray-200 overflow-x-hidden no-scrollbar flex h-9">
    <div class="sticky flex items-center bg-gray-50 left-0">
      <NcDropdown
        ...
        overlay-class-name="max-h-96 relative scroll-container cv-scrollbar-md overflow-auto"
      >
        <div
        ...
        >
          <div class="flex relative justify-between gap-2 w-full">
            <template v-if="!disablePagination">
              <div v-if="isViewDataLoading" class="cv-pagination-skeleton flex justify-center item-center min-h-10 min-w-16 w-16">
              ...
              <NcTooltip v-else class="flex sticky items-center h-full">
                ...
                <span
                  ...
                  class="text-gray-500 text-ellipsis overflow-hidden pl-1 truncate cv-grid-row-count caption text-xs text-nowrap"
                >
