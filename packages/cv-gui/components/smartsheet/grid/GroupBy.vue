...
import { CommonAggregations, UITypes, dateFormats, parseStringDateTime, timeFormats } from 'clairview-sdk'
    ...
    <div ref="scrollable" :style="`${vGroup.root === true ? 'width: fit-content' : 'width: 100%'}`">
      ...
      <div :class="{ 'pl-2': vGroup.root === true }">
        <a-collapse
          ...
          class="cv-group-wrapper !rounded-lg"
          :bordered="false"
        ...
        >
          <a-collapse-panel
            ...
            class="!border-1 border-gray-300 cv-group rounded-[8px] mb-2"
                ...
                >
                  <div class="flex items-center">
                    ...
                    <div class="flex">
                      ...
                      >
                        <span
                          class="cv-group-value font-semibold text-[13px]"
                          :style="{
                  ...
                  >
                    <div class="text-xs group-hover:hidden text-gray-500 cv-group-row-count">
                      <span>
                        {{ $t('datatype.Count') }}
                      </span>
