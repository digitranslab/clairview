...
import type { ColumnType, GridType } from 'clairview-sdk'
...
<template>
  <div
    class="relative flex flex-col h-full min-h-0 w-full cv-grid-wrapper"
    data-testid="cv-grid-wrapper"
    :style="`background-color: ${isGroupBy ? `${baseColor}` : 'var(--cv-grid-bg)'};`"
  >
    <Table
