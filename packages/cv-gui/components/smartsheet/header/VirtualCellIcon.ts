...
import type { ColumnType, LinkToAnotherRecordType, LookupType, RollupType } from 'clairview-sdk'
import { ButtonActionsType, RelationTypes, UITypes } from 'clairview-sdk'
...
export default defineComponent({
  ...
  setup(props) {
    ...
    return () => {
      ...
      return h(Icon, { class: `${color || 'text-grey'} mx-1 cv-virtual-cell-icon` })
    }
  },
})
