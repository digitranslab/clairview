...
import { type ColumnReqType, type ColumnType, partialUpdateAllowedTypes, readonlyMetaAllowedTypes } from 'clairview-sdk'
import { UITypes, UITypesName } from 'clairview-sdk'
...
<template>
  <div
    ...
    :class="{
      ...
      'cv-cell-expanded-form-header cursor-pointer hover:bg-gray-100':
  ...
  >
    <div
      class="cv-cell-name-wrapper flex-1 flex items-center"
      :class="{
    ...
    <a-dropdown
      ...
      :overlay-class-name="`cv-dropdown-edit-column ${editColumnDropdown ? 'active' : ''}`"
