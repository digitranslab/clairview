...
import { type ColumnType, columnTypeName, isSupportedDisplayValueColumn, isSystemColumn, isVirtualCol } from 'clairview-sdk'
...
<template>
  <NcModal v-model:visible="value" size="small">
    <div class="flex flex-col gap-3">
      ...
      <div class="border-1 rounded-lg border-cv-border-gray-medium h-[250px]">
        <NcList
