...
import { PlanLimitTypes, RelationTypes, UITypes, isLinksOrLTAR, isSupportedDisplayValueColumn, isSystemColumn } from 'clairview-sdk'
...
<template>
  <a-dropdown
    ...
    overlay-class-name="cv-dropdown-column-operations !border-1 rounded-lg !shadow-xl "
  ...
  >
    <div class="flex gap-1 items-center" @dblclick.stop>
      ...
      <GeneralIcon
        ...
        icon="arrowDown"
        class="text-grey h-full text-grey cv-ui-dt-dropdown cursor-pointer outline-0 mr-2"
      />
    </div>
    <template #overlay>
      <NcMenu
        class="flex flex-col gap-1 border-gray-200 cv-column-options"
        :class="{
      ...
      >
        ...
        >
          ...
          <div
            class="cv-copy-field flex flex-row justify-between items-center w-[calc(100%_-_12px)] p-2 mx-1.5 rounded-md hover:bg-gray-100 cursor-pointer group"
        ...
        <GeneralSourceRestrictionTooltip message="Field properties cannot be edited." :enabled="!isColumnEditAllowed">
          ...
          >
            <div class="cv-column-edit cv-header-menu-item">
        ...
        <template v-if="!isExpandedForm">
          <GeneralSourceRestrictionTooltip message="Field cannot be duplicated." :enabled="!isDuplicateAllowed && isMetaReadOnly">
            <NcMenuItem v-if="!column?.pk" :disabled="!isDuplicateAllowed" @click="openDuplicateDlg">
              <div v-e="['a:field:duplicate']" class="cv-column-duplicate cv-header-menu-item">
        ...
        <NcMenuItem v-if="isUIAllowed('fieldAlter')" title="Add field description" @click="onEditPress($event, true)">
          <div class="cv-column-edit-description cv-header-menu-item">
        ...
        <NcMenuItem v-if="[UITypes.LinkToAnotherRecord, UITypes.Links].includes(column.uidt)" @click="openLookupMenuDialog">
          <div v-e="['a:field:lookup:create']" class="cv-column-lookup-create cv-header-menu-item">
        ...
        <NcMenuItem v-if="!column?.pv" @click="hideOrShowField">
          <div v-e="['a:field:hide']" class="cv-column-insert-before cv-header-menu-item">
        ...
        >
          ...
          <NcMenuItem :disabled="!isSupportedDisplayValueColumn(column)" @click="setAsDisplayValue">
            <div class="cv-column-set-primary cv-header-menu-item item">
        ...
        <template v-if="!isExpandedForm">
          ...
          <template v-if="!isLinksOrLTAR(column) || column.colOptions.type !== RelationTypes.BELONGS_TO">
            <NcTooltip :disabled="isSortSupported">
              ...
              <NcMenuItem :disabled="!isSortSupported" @click="sortByColumn('asc')">
                <div v-e="['a:field:sort', { dir: 'asc' }]" class="cv-column-insert-after cv-header-menu-item">
            ...
            <NcTooltip :disabled="isSortSupported">
              ...
              <NcMenuItem :disabled="!isSortSupported" @click="sortByColumn('desc')">
                <div v-e="['a:field:sort', { dir: 'desc' }]" class="cv-column-insert-before cv-header-menu-item">
                  <!-- Sort Descending -->
          ...
          <NcTooltip :disabled="isFilterSupported && !isFilterLimitExceeded">
            ...
            >
              <div v-e="['a:field:add:filter']" class="cv-column-filter cv-header-menu-item">
          ...
          >
            ...
            <NcMenuItem
              ...
              "
            >
              <div v-e="['a:field:add:groupby']" class="cv-column-groupby cv-header-menu-item">
          ...
          <NcMenuItem @click="onInsertAfter">
            <div v-e="['a:field:insert:after']" class="cv-column-insert-after cv-header-menu-item">
          ...
          <NcMenuItem v-if="!column?.pv" @click="onInsertBefore">
            <div v-e="['a:field:insert:before']" class="cv-column-insert-before cv-header-menu-item">
        ...
        <GeneralSourceRestrictionTooltip message="Field cannot be deleted." :enabled="!isColumnUpdateAllowed">
          ...
          >
            <div
              class="cv-column-delete cv-header-menu-item"
...
:deep(.ant-dropdown-menu-item.ant-dropdown-menu-item-disabled .cv-icon) {
  @apply text-current;
}
</style>
