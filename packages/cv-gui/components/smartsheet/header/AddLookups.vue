...
import { type ColumnType, UITypes, isLinksOrLTAR, isSystemColumn, isVirtualCol } from 'clairview-sdk'
...
<template>
  <NcModal v-model:visible="value" size="small">
    <div class="flex flex-col gap-3">
      ...
      <div class="border-1 rounded-md h-[300px] cv-scrollbar-md border-gray-200">
        <Draggable v-model="filteredColumns" item-key="id" ghost-class="cv-lookup-menu-items-ghost">
          <template #item="{ element: field }">
            <div
              :key="field.id"
              :data-testid="`cv-lookup-add-menu-${field.title}`"
