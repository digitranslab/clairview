...
<template>
  ...
  <div class="flex flex-col h-full w-full no-underline" data-testid="cv-map-wrapper">
    <div id="mapContainer" ref="mapContainerRef" class="w-full h-screen">
      <a-tooltip placement="bottom" class="h-2 w-auto max-w-fit-content absolute top-3 right-3 p-2 z-500 cursor-default">
        ...
        <div v-if="count > 900" class="cv-warning-info flex min-w-32px h-32px items-center gap-1 px-2 bg-white">
