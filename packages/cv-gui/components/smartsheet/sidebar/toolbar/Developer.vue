...
<template>
  <div class="flex flex-col px-3 cv-scrollbar-md">
    <div
      v-if="!isMobileMode"
      v-e="['c:erd:open']"
      class="py-2 flex gap-2 items-center cv-view-sidebar-erd button"
      @click="showErd = true"
    >
    ...
    <div
      v-e="['c:snippet:open']"
      class="py-2 flex gap-2 items-center button cv-view-sidebar-api-snippet"
