...
<template>
  <div class="flex flex-row p-1 bg-gray-200 rounded-lg gap-x-0.5 cv-view-sidebar-tab">
    <div
    ...
    >
      ...
      <div class="tab-title cv-tab">{{ $t('general.data') }}</div>
    </div>
    <div
    ...
    >
      ...
      />
      <div class="tab-title cv-tab">{{ $t('general.details') }}</div>
    </div>
  </div>
</template>
