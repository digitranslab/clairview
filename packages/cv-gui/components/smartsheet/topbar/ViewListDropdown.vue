...
import { type ViewType, ViewTypes } from 'clairview-sdk'
 ...
 *
 * @see {@link packages/cv-gui/components/dashboard/TreeView/CreateViewBtn.vue} for a similar implementation of view creation dialog.
      ...
      >
        ...
        <template v-if="!isMobileMode && isUIAllowed('viewCreateOrEdit')" #listFooter>
          ...
          <div class="overflow-hidden mb-2">
            <a-menu class="cv-viewlist-menu">
              <a-sub-menu popup-class-name="cv-viewlist-submenu-popup ">
                <template #title>
                ...
                <a-menu-item @click.stop="onOpenModal({ type: ViewTypes.GRID })">
                  <div class="cv-viewlist-submenu-popup-item" data-testid="topbar-view-create-grid">
                ...
                >
                  <a-menu-item :disabled="!!activeSource?.is_data_readonly" @click="onOpenModal({ type: ViewTypes.FORM })">
                    <div
                      class="cv-viewlist-submenu-popup-item"
                ...
                <a-menu-item @click="onOpenModal({ type: ViewTypes.GALLERY })">
                  <div class="cv-viewlist-submenu-popup-item" data-testid="topbar-view-create-gallery">
                ...
                <a-menu-item data-testid="topbar-view-create-kanban" @click="onOpenModal({ type: ViewTypes.KANBAN })">
                  <div class="cv-viewlist-submenu-popup-item">
                ...
                <template v-if="isFeatureEnabled(FEATURE_FLAG.AI_FEATURES)">
                  ...
                  <a-menu-item data-testid="sidebar-view-create-ai" @click="onOpenModal({ type: 'AI' })">
                    <div class="cv-viewlist-submenu-popup-item">
                      <GeneralIcon icon="ncAutoAwesome" class="!w-4 !h-4 text-cv-fill-purple-dark" />
...
.cv-viewlist-submenu-popup {
  ...
  .ant-menu-item {
    ...
    .cv-viewlist-submenu-popup-item {
...
.cv-viewlist-submenu-popup .ant-dropdown-menu.ant-dropdown-menu-sub {
