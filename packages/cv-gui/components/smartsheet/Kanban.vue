...
import { ViewTypes, isVirtualCol } from 'clairview-sdk'
...
<template>
  ...
  >
    <div
      ...
      class="cv-kanban-container flex p-3 overflow-y-hidden w-full cv-scrollbar-x-lg"
      :style="{
    ...
    >
      ...
      <NcDropdown
        ...
        :trigger="['contextmenu']"
        overlay-class-name="cv-dropdown-kanban-context-menu"
      >
        <div class="flex gap-3">
          ...
          <Draggable
            ...
            item-key="id"
            group="kanban-stack"
            draggable=".cv-kanban-stack"
            handle=".cv-kanban-stack-drag-handler"
          ...
          >
            <template #item="{ element: stack, index: stackIdx }">
              <div
                ...
                :data-testid="`cv-kanban-stack-${stack.title}`"
              >
                ...
                >
                  ...
                  <a-layout v-else>
                    <a-layout-header
                      ...
                      :class="`cv-kanban-stack-header-${stack.id}`"
                    >
                      <div
                        class="cv-kanban-stack-head w-full flex gap-1"
                        :class="{
                      ...
                      >
                        ...
                        >
                          <NcButton
                            ...
                            type="text"
                            size="xs"
                            class="cv-kanban-stack-drag-handler !px-1.5 !cursor-move !:disabled:cursor-not-allowed mt-0.5"
                          >
                            ...
                            >
                              ...
                              >
                                <NcTooltip class="truncate max-w-full" placement="bottom" show-on-truncate-only>
                                  ...
                                  <span
                                    data-testid="cv-kanban-stack-title"
                        ...
                        <NcDropdown
                          ...
                          overlay-class-name="cv-dropdown-kanban-stack-context-menu"
                        ...
                        >
                          <NcButton
                            ...
                            size="xs"
                            class="!px-1.5 mt-0.5"
                            data-testid="cv-kanban-stack-context-menu"
                          >
                          ...
                          <template #overlay>
                            <NcMenu class="!text-sm">
                              <NcMenuItem
                                ...
                                data-testid="cv-kanban-context-menu-add-new-record"
                                @click="
                                  () => {
                              ...
                              <NcMenuItem
                                ...
                                data-testid="cv-kanban-context-menu-rename-stack"
                                @click="
                                  () => {
                                    isRenameOrNewStack = stack
                                  }
                              ...
                              <NcMenuItem
                                ...
                                data-testid="cv-kanban-context-menu-collapse-stack"
                              ...
                              <NcMenuItem
                                ...
                                data-testid="cv-kanban-context-menu-collapse-all-stack"
                              ...
                              <NcMenuItem
                                ...
                                data-testid="cv-kanban-context-menu-expand-all-stack"
                              ...
                              <template v-if="stack.title !== null && !isPublic && hasEditPermission">
                                ...
                                <NcMenuItem
                                  ...
                                  data-testid="cv-kanban-context-menu-delete-stack"
                    ...
                    >
                      <div
                        :ref="kanbanListRef"
                        class="cv-kanban-list h-full px-2 cv-scrollbar-thin"
                      ...
                      >
                        ...
                        >
                          <template #item="{ element: record, index }">
                            <div class="cv-kanban-item py-1 first:pt-2 last:pb-2">
                              <LazySmartsheetRow :row="record">
                                <a-card
                                  ...
                                  :data-testid="`cv-gallery-card-${record.row.id}`"
                                  :class="{
                                ...
                                >
                                  ...
                                  <div class="flex flex-col gap-3 !children:pointer-events-none">
                                    <h2
                                      v-if="displayField"
                                      class="cv-card-display-value-wrapper"
                                      :class="{
                                    ...
                                    >
                                      <div class="flex flex-col rounded-lg w-full">
                                        <div class="flex flex-row w-full justify-start">
                                          <div class="cv-card-col-header w-full !children:text-gray-500">
                    ...
                    <a-layout-footer v-if="formattedData.get(stack.title)" class="border-t-1 border-gray-100">
                      <div class="flex items-center justify-between">
                        ...
                        <!-- Record Count -->
                        <div class="cv-kanban-data-count text-gray-500 font-weight-500 px-1">
                ...
                <a-card
                  ...
                  class="cv-kanban-collapsed-stack flex items-center w-68.5 h-[44px] !rounded-xl cursor-pointer h-full !p-2 overflow-hidden !shadow-none !hover:shadow-none !border-gray-200"
                  :class="{
                    'not-draggable': stack.title === null || isLocked || isPublic || !hasEditPermission,
                  }"
                  :body-style="{
                ...
                >
                  <div class="h-full flex items-center justify-between" @click="handleCollapseStack(stackIdx)">
                    ...
                    <div v-else class="cv-kanban-stack-head w-full flex items-center justify-between gap-2">
                      <div class="flex items-center gap-1">
                        <NcButton
                          ...
                          type="text"
                          size="xs"
                          class="cv-kanban-stack-drag-handler !px-1.5 !cursor-move"
                          @click.stop
                        >
                      ...
                      <div class="flex items-center gap-2 truncate">
                        <div
                          class="cv-kanban-data-count px-1 rounded bg-gray-200 text-gray-800 text-sm font-weight-500 truncate"
          ...
          <div v-if="hasEditPermission && !isPublic && !isLocked && groupingFieldColumn?.id" class="cv-kanban-add-new-stack">
            <!-- Add New Stack -->
            <a-card
              class="flex flex-col w-68.5 !rounded-xl overflow-y-hidden !shadow-none !hover:shadow-none border-gray-200 cv-kanban-stack-header-new-stack"
              :class="[
                {
                  '!cursor-default': isLocked || !hasEditPermission,
        ...
        <template v-if="!isLocked && !isPublic && hasEditPermission" #overlay>
          <NcMenu @click="contextMenu = false">
            <NcMenuItem v-if="contextMenuTarget" @click="expandForm(contextMenuTarget)">
              <div v-e="['a:kanban:expand-record']" class="flex items-center gap-2 cv-kanban-context-menu-item">
            ...
            <NcMenuItem v-if="contextMenuTarget" class="!text-red-600 !hover:bg-red-50" @click="deleteRow(contextMenuTarget)">
              <div v-e="['a:kanban:delete-record']" class="flex items-center gap-2 cv-kanban-context-menu-item">
...
.ant-carousel.gallery-carousel :deep(.slick-dots) {
  @apply !w-full max-w-[calc(100%_-_36%)] absolute left-0 right-0 bottom-[-18px] h-6 overflow-x-auto cv-scrollbar-thin !mx-auto;
}
...
:deep(.cv-cell) {
  ...
  &.cv-cell-singleselect .cv-cell-field > div {
    @apply flex items-center;
  }
  &.cv-cell-multiselect .cv-cell-field > div {
    @apply h-5;
  }
  &.cv-cell-email,
  &.cv-cell-phonenumber {
...
:deep(.cv-virtual-cell) {
  ...
  &.cv-virtual-cell-linktoanotherrecord {
    .chips-wrapper {
  ...
  &.cv-virtual-cell-lookup {
    .cv-lookup-cell {
      &:has(.cv-attachment-wrapper) {
        @apply !h-auto;
      ...
      &:not(:has(.cv-attachment-wrapper)) {
        @apply !h-5.5;
      }
      .cv-cell-lookup-scroll {
        @apply py-0 h-auto;
      }
    }
  }
  &.cv-virtual-cell-formula {
    .cv-cell-field {
      @apply py-0;
    }
  }

  &.cv-virtual-cell-qrcode,
  &.cv-virtual-cell-barcode {
