...
<template>
  <div>
    <a-button class="cv-btn-find-row-by-scan cv-toolbar-btn" @click="showCodeScannerOverlay = true">
    ...
    <a-modal
      ...
      class="cv-overlay-find-row-by-scan"
      :closable="false"
      width="28rem"
      centered
      :footer="null"
    ...
    >
      <div class="relative flex flex-col h-full">
        ...
        <a-form-item :label="$t('labels.columnToScanFor')" class="cv-dropdown-scanner-column-id">
          <a-select
