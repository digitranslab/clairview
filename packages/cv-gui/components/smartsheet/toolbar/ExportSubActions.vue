...
import type { RequestParams } from 'clairview-sdk'
import { ExportTypes } from 'clairview-sdk'
...
const exportFile = async (exportType: ExportTypes) => {
  ...
  try {
    while (!isNaN(offset) && offset > -1) {
      ...
      offset = +headers['cv-export-offset']
...
<template>
  ...
  <a-menu-item class="!mx-1 !py-2 !rounded-md">
    <div
      v-e="['a:download:csv']"
      class="flex flex-row items-center cv-base-menu-item !py-0"
