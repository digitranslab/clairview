...
const updateHighlightPosition = () => {
  nextTick(() => {
    const activeTab = document.querySelector('.cv-calendar-mode-tab .tab.active') as HTMLElement
    if (activeTab) {
...
<template>
  <div
    v-if="isTab"
    class="px-1 pointer-events-auto relative mx-3 mt-1 mb-2.5 rounded-lg gap-x-0.5 relative cv-calendar-mode-tab"
    data-testid="cv-calendar-view-mode"
  >
    <div class="flex flex-row">
      ...
      <div
        ...
        :data-testid="`cv-calendar-view-mode-${mode}`"
  ...
  <a-select
    ...
    class="cv-select-shadow !w-21 !rounded-lg"
