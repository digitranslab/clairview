...
<template>
  <div class="cv-locked-menu-item !px-1 text-gray-800 w-full max-w-[312px]" @click="emit('select', type)">
    <div :class="{ 'show-tick': !hideTick }">
      <div class="w-full flex flex-col gap-y-1">
        ...
        <div
          v-if="!hideTick"
          class="cv-subtitle max-w-120 text-xs whitespace-normal ml-6 pr-6"
          :class="{
            'text-gray-400': disabled,
