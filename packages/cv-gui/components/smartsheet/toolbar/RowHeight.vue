...
import type { GridType } from 'clairview-sdk'
import { OrgUserRoles, ProjectRoles, extractRolesObj } from 'clairview-sdk'
...
<template>
  <a-dropdown v-model:visible="open" offset-y class="" :trigger="['click']" overlay-class-name="cv-dropdown-height-menu">
    <div>
      <NcButton
        v-e="['c:row-height']"
        class="cv-height-menu-btn cv-toolbar-btn !border-0 !h-7 !px-1.5 !min-w-7"
        size="small"
        type="secondary"
        ...
        <div class="flex flex-col w-full text-sm" @click.stop>
          ...
          >
            <div class="flex items-center gap-2">
              <GeneralIcon :icon="item.icon" class="cv-row-height-icon" />
