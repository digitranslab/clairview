...
<template>
  <NcDropdown :trigger="['click']" overlay-class-name="cv-dropdown-actions-menu">
    <NcButton v-e="['c:actions']" class="cv-actions-menu-btn cv-toolbar-btn" size="xs" type="secondary">
