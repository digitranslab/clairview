...
<template>
  ...
  <div
    v-else
    class="bg-white border-1 flex flex-grow min-h-4 h-full px-1 items-center cv-filter-input-wrapper !rounded-lg"
  ...
  >
    <component
      ...
      :class="{
        'text-cv-content-gray-muted pointer-events-none': props.disabled,
      }"
