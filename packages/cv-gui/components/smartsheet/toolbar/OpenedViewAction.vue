...
<template>
  ...
  <NcDropdown
    ...
    class="!xs:pointer-events-none cv-actions-menu-btn cv-view-context-btn"
    overlay-class-name="cv-dropdown-actions-menu"
  >
    <div>
      <NcButton
        v-e="['c:toolbar:view-actions']"
        class="cv-view-action-menu-btn cv-toolbar-btn !border-0 !h-7 !px-1.5 !min-w-7"
        size="small"
        type="secondary"
      >
