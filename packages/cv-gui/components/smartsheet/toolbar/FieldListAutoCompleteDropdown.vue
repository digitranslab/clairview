...
import { RelationTypes, UITypes, isHiddenCol, isLinksOrLTAR, isSystemColumn, isVirtualCol } from 'clairview-sdk'
...
<template>
  <NcSelect
    ...
    dropdown-class-name="cv-dropdown-toolbar-field-list"
  >
