...
import { ViewLockType } from 'clairview-sdk'
...
<template>
  ...
  >
        ...
        <template #default="{ isOpen }">
          ...
          >
            ...
            <template v-if="isSharedBase">
              <NcTooltip
                class="ml-1 truncate cv-active-base-title max-w-full !leading-5"
      ...
      <SmartsheetTopbarTableListDropdown v-if="activeTable">
        <template #default="{ isOpen }">
          ...
          >
            ...
            <NcTooltip class="truncate cv-active-table-title max-w-full !leading-5" show-on-truncate-only :disabled="isOpen">
              <template #title>
                {{ activeTable?.title }}
              </template>
              <span
    ...
    <GeneralIcon v-if="!isMobileMode" icon="ncSlash1" class="cv-breadcrumb-divider" />
        ...
        <template #default="{ isOpen }">
          ...
          >
            ...
            >
              ...
              <NcTooltip class="truncate cv-active-view-title max-w-full !leading-5" show-on-truncate-only disabled>
                <template #title>
                  {{ activeView?.is_default ? $t('title.defaultView') : activeView?.title }}
                </template>
                <span
