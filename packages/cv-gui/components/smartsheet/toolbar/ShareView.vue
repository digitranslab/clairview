...
import { ViewTypes } from 'clairview-sdk'
...
<template>
  <div>
    <a-button
      ...
      v-e="['c:view:share']"
      outlined
      class="cv-btn-share-view cv-toolbar-btn"
      @click="genShareLink"
    >
    ...
    <a-modal
      ...
      wrap-class-name="cv-modal-share-view"
    >
      <div class="share-link-box !bg-primary !bg-opacity-5 ring-1 ring-accent ring-opacity-100">
        <div data-testid="cv-modal-share-view__link" class="flex-1 h-min text-xs text-gray-500">{{ sharedViewUrl }}</div>
        ...
        <div class="px-1 flex flex-col gap-2">
          <div>
            <a-checkbox
              ...
              data-testid="cv-modal-share-view__survey-mode"
              class="!text-sm"
            >
              ...
              <div v-if="surveyMode" class="flex flex-col justify-center pl-6">
                <a-form-item class="!my-1" :has-feedback="false" name="transitionDuration">
                  ...
                  <a-input
                    ...
                    data-testid="cv-form-signin__email"
                    size="small"
                    class="!w-32"
                    type="number"
          ...
          <div>
            ...
            <a-checkbox
              ...
              data-testid="cv-modal-share-view__with-password"
              class="!text-sm !my-1"
            >
            ...
            <Transition name="layout" mode="out-in">
              <div v-if="passwordProtected" class="pl-6 flex gap-2 mt-2 mb-4">
                <a-input
                  ...
                  data-testid="cv-modal-share-view__password"
                  size="small"
                ...
                <a-button
                  data-testid="cv-modal-share-view__save-password"
                  size="small"
                  class="!text-xs"
          ...
          >
            <!-- Allow Download -->
            <a-checkbox v-model:checked="allowCSVDownload" data-testid="cv-modal-share-view__with-csv-download" class="!text-sm">
              {{ $t('labels.downloadAllowed') }}
            </a-checkbox>
          </div>

          <div v-if="shared.type === ViewTypes.FORM">
            <a-checkbox v-model:checked="viewTheme" data-testid="cv-modal-share-view__with-theme" class="!text-sm">
              {{ $t('activity.useTheme') }}
            </a-checkbox>
            ...
            <Transition name="layout" mode="out-in">
              <div v-if="viewTheme" class="flex pl-6">
                <LazyGeneralColorPicker
                  data-testid="cv-modal-share-view__theme-picker"
                  class="!p-0"
          ...
          <div v-if="shared.type === ViewTypes.FORM && isRtl">
            <a-checkbox v-model:checked="withRTL" data-testid="cv-modal-share-view__locale" class="!text-sm">
