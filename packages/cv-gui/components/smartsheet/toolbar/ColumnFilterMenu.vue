...
<template>
  <NcDropdown
    ...
    :trigger="['click']"
    overlay-class-name="cv-dropdown-filter-menu cv-toolbar-dropdown overflow-hidden"
    class="!xs:hidden"
  >
    <NcTooltip :disabled="!isMobileMode && !isToolbarIconMode">
      ...
      <NcButton
        v-e="['c:filter']"
        class="cv-filter-menu-btn cv-toolbar-btn !border-0 !h-7"
        size="small"
        type="secondary"
