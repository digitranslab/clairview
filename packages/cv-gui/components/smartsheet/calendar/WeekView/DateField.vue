...
<template>
  <div class="flex relative flex-col prevent-select" data-testid="cv-calendar-week-view" @drop="dropEvent">
    <div class="flex h-6">
      <div
    ...
    <div
      class="absolute cv-scrollbar-md overflow-y-auto z-2 mt-6 pointer-events-none inset-0"
    ...
    >
      <template v-for="(record, id) in calendarData" :key="id">
        <div
          ...
          class="absolute group draggable-record pointer-events-auto cv-calendar-week-record-card"
