...
<template>
  ...
  >
    ...
    <NcButton data-testid="cv-calendar-side-bar-btn" size="small" type="secondary" @click="toggleSideMenu">
  ...
  <div
    :class="{
      ...
      'cv-calendar-side-menu-open block !min-w-[288px]': props.visible,
    }"
    class="h-full relative border-l-1 border-gray-200 transition-all"
    data-testid="cv-calendar-side-menu"
  >
    ...
    >
      <div class="flex px-4 items-center gap-3">
        ...
        <NcSelect
          ...
          data-testid="cv-calendar-sidebar-filter"
        >
      ...
      >
        <a-input
          ...
          data-testid="cv-calendar-sidebar-search"
      ...
      <div class="mx-4 gap-2 flex items-center">
        <NcButton
          v-if="!showSearch"
          data-testid="cv-calendar-sidebar-search-btn"
          size="small"
        ...
        <NcButton
          ...
          data-testid="cv-calendar-side-menu-new-btn"
          class="!h-7 !rounded-md"
          size="small"
          type="secondary"
          @click="newRecord"
      ...
      <div
        ...
        class="cv-scrollbar-md pl-4 pr-4 overflow-y-auto"
        data-testid="cv-calendar-side-menu-list"
            ...
            <LazySmartsheetRow v-for="(record, rowIndex) in renderData" :key="rowIndex" :row="record">
              ...
              "
                ...
                record.rowMeta.range!.fk_to_col
                  ...
                  : null
              "
                data-testid="cv-sidebar-record-card"
...
:deep(.cv-month-picker-pagination) {
  @apply !border-b-0;
}

:deep(.cv-date-week-header) {
  @apply !border-b-0;
}
</style>
