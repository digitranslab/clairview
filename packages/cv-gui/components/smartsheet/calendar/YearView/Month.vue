...
<template>
  <div>
    <div class="flex justify-center px-2 cv-date-week-header text-gray-700 text-sm py-2 font-semibold items-center">
      {{ currentMonthYear }}
    </div>
    <div
      :class="{
    ...
    >
      ...
      <div class="grid gap-x-0.5 gap-y-2 px-2.5 py-1 cv-date-week-grid-wrapper grid-cols-7">
        <span
          ...
          :class="{
            ...
            'text-brand-500 !font-semibold cv-calendar-today': isSameDate(date, dayjs()) && isDateInCurrentMonth(date),
