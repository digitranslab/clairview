...
<template>
  <div ref="calendarContainer" class="overflow-auto flex my-2 transition-all justify-center cv-scrollbar-md">
    <div
      :class="{
        'grid-cols-1': cols === 1,
        'grid-cols-2': cols === 2,
      ...
      data-testid="cv-calendar-year-view"
    >
      <LazySmartsheetCalendarYearViewMonth
        ...
        :size="size"
        class="cv-year-view-calendar"
        data-testid="cv-calendar-year-view-month-selector"
