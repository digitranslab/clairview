...
<template>
  <div v-if="calendarRange" class="h-full prevent-select relative" data-testid="cv-calendar-month-view">
    <div
      class="grid"
      :class="{
    ...
    >
      <div
        ...
        data-testid="cv-calendar-month-week"
      >
        <template v-for="(day, i) in week.days">
          <div
            ...
            data-testid="cv-calendar-month-day"
    ...
    <div class="absolute inset-0 z-2 pointer-events-none mt-8 pb-7.5" data-testid="cv-calendar-month-record-container">
      <template v-for="record in recordsToDisplay.records">
        <div
          v-if="record.rowMeta.style?.display !== 'none'"
          :key="record.rowMeta.id"
          :data-testid="`cv-calendar-month-record-${record.row[displayField!.title!]}`"
