      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex flex-col">
          <NcDropdown
            ...
            overlay-class-name="cv-form-field-visibility-dropdown"
          >
            <NcTooltip placement="left" :disabled="!isFirstField">
              <template #title> Cannot add conditions to the first field in a form. </template>
              <div
                class="cv-form-field-visibility-btn border-1 rounded-lg py-1 px-3 flex items-center justify-between gap-2 !min-w-[170px] transition-all cursor-pointer select-none text-sm"
                :class="{
                  '!border-brand-500 shadow-selected': isOpen,
                  'border-gray-200': !isOpen,
                  'bg-[#F0F3FF]': visibilityFilters.length,
                  'opacity-70 cursor-default cv-disabled': isFirstField && !visibilityFilters.length,
                }"
                data-testid="cv-form-field-visibility-btn"
              >
                <div
                  class="cv-form-field-visibility-conditions-count flex-1"
                  :class="{
            ...
            <template #overlay>
              <div
                class="cv-form-field-visibility-dropdown-container"
                :class="{
...
<style lang="scss">
.cv-form-field-visibility-dropdown {
