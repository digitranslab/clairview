...
<template>
  <div v-if="!isVisibleDefaultValueInput">
    <NcButton
      ...
      type="text"
      class="text-gray-700"
      data-testid="cv-show-default-value-btn"
  ...
  <div v-else>
    ...
    <div class="flex flex-row gap-2">
      <div
        class="cv-default-value-wrapper cv-rich-long-text-default-value border-1 relative pt-7 flex items-center w-full px-0 border-gray-300 rounded-md max-h-70 pb-1 focus-within:(border-brand-500 shadow-selected) transition-all duration-0.3s"
        :class="{
...
.cv-rich-long-text-default-value {
  :deep(.cv-rich-text) {
