...
import { getAvailableRollupForUiType, isLinksOrLTAR, isSystemColumn, isVirtualCol } from 'clairview-sdk'
  ...
  <div v-if="refTables.length" class="flex flex-col gap-4">
    <div class="w-full flex flex-row space-x-2">
      ...
      >
        <a-select
          ...
          placeholder="-select-"
          dropdown-class-name="!w-64 cv-dropdown-relation-table !rounded-md"
      ...
      >
        <a-select
          ...
          dropdown-class-name="cv-dropdown-relation-column !rounded-xl"
    ...
    >
      <a-select
        ...
        :disabled="!vModel.fk_relation_column_id"
        placeholder="-select-"
        dropdown-class-name="cv-dropdown-rollup-function"
        class="!mt-0.5"
