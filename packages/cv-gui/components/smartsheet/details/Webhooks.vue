...
import type { HookType } from 'clairview-sdk'
...
<template>
  <div class="cv-webhook-wrapper w-full p-4">
      ...
      <div v-if="activeView && !isHooksLoading">
        <div class="w-full mb-4 flex justify-between gap-3">
          <div class="flex-1 flex gap-2">
            <a-input
              ...
              class="w-full cv-input-sm cv-input-border-on-value !max-w-84"
              size="small"
            ...
            <NcButton
              ...
              type="text"
              size="small"
              @click="navigateTo('https://docs.clairview.com/category/webhook/', { open: navigateToBlankTargetOpenOption })"
            >
        ...
        <div style="height: calc(100vh - (var(--topbar-height) * 3.5))" class="">
          ...
          <NcTable
            ...
            class="h-full"
            body-row-class-name="cv-view-sidebar-webhook-item"
          >
            <template #bodyCell="{ column, record: hook }">
              ...
              <template v-if="column.key === 'action'">
                <NcDropdown overlay-class-name="cv-webhook-item-action-dropdown">
                  <NcButton type="secondary" size="small" class="!w-8 !h-8" data-testid="cv-webhook-item-action" @click.stop>
                    <component :is="iconMap.threeDotVertical" class="text-gray-700" />
                  </NcButton>
                  <template #overlay>
                    <NcMenu class="w-48">
                      <NcMenuItem key="edit" data-testid="cv-webhook-item-action-edit" @click="editHook(hook)">
                        <GeneralIcon icon="edit" class="text-gray-800" />
                        <span>{{ $t('general.edit') }}</span>
                      </NcMenuItem>
                      <NcMenuItem key="duplicate" data-testid="cv-webhook-item-action-duplicate" @click="copyWebhook(hook)">
                      ...
                      <NcMenuItem
                        ...
                        data-testid="cv-webhook-item-action-delete"
