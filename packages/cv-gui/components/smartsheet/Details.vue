...
<template>
  <div
    ...
    data-testid="cv-details-wrapper"
    :class="{
      'cv-details-tab-left-sidebar-close': !isLeftSidebarOpen,
    }"
  >
    <NcTabs v-model:activeKey="openedSubTab" centered class="cv-details-tab">
      <a-tab-pane v-if="isUIAllowed('fieldAdd')" key="field">
        <template #tab>
          <div class="tab" data-testid="cv-fields-tab">
      ...
      <a-tab-pane key="relation">
        <template #tab>
          <div class="tab" data-testid="cv-relations-tab">
      ...
      <a-tab-pane key="api">
        <template #tab>
          <div class="tab" data-testid="cv-apis-tab">
      ...
      <a-tab-pane v-if="isUIAllowed('hookList')" key="webhook">
        <template #tab>
          <div class="tab" data-testid="cv-webhooks-tab">
...
:deep(.cv-details-tab > .ant-tabs-nav:first-of-type) {
...
<style lang="scss">
.cv-details-tab.cv-tabs.centered {
  > .ant-tabs-nav {
    @apply px-3;
    .ant-tabs-nav-wrap {
...
.cv-details-tab-left-sidebar-close > .cv-details-tab.cv-tabs.centered {
  > .ant-tabs-nav {
    @apply px-3;
    .ant-tabs-nav-wrap {
      @apply absolute mx-auto;
