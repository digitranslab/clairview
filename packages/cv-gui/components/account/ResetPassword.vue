  ...
  <div class="flex flex-col">
    ...
    <div class="cv-content-max-w p-6 h-[calc(100vh_-_100px)] flex flex-col gap-6 overflow-auto cv-scrollbar-thin">
      <div class="mx-auto relative flex flex-col justify-start gap-2 w-full md:(bg-white) max-w-[900px]">
        <a-form
          ref="formValidator"
          data-testid="cv-user-settings-form"
          layout="vertical"
        ...
        >
          <Transition name="layout">
            <div v-if="error" class="mx-auto mb-4 bg-red-500 text-white rounded-lg w-3/4 p-1">
              <div data-testid="cv-user-settings-form__error" class="flex items-center gap-2 justify-center" data-rec="true">
          ...
          >
            <a-input-password
              ...
              data-testid="cv-user-settings-form__current-password"
              size="large"
              class="password"
          ...
          <a-form-item :label="$t('placeholder.password.new')" data-rec="true" name="password" :rules="formRules.password">
            <a-input-password
              ...
              data-testid="cv-user-settings-form__new-password"
              size="large"
              class="password"
          ...
          >
            <a-input-password
              ...
              data-testid="cv-user-settings-form__new-password-repeat"
              size="large"
              class="password"
          ...
          <div class="text-right">
            <a-button
              size="middle"
              data-testid="cv-user-settings-form__submit"
