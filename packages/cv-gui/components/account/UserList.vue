...
import { OrgUserRoles } from 'clairview-sdk'
import type { OrgUserReqType, RequestParams, UserType } from 'clairview-sdk'
...
<template>
  <div class="flex flex-col" data-testid="cv-super-user-list">
    <NcPageHeader>
      <template #icon>
        ...
        <div class="max-w-195 mx-auto h-full">
          <div class="flex gap-4 items-center justify-between">
            ...
            <div class="flex gap-3 items-center justify-center">
              ...
              <NcButton data-testid="cv-super-user-invite" size="small" type="primary" @click="openInviteModal">
              ...
              <template v-if="column.key === 'role'">
                ...
                >
                  <a-select-option
                    ...
                    :key="idx"
                    class="cv-users-list-role-option"
                    :value="option.value"
                  >
                    <div class="w-full flex items-start gap-1">
                      <div class="flex-1">
                        ...
                        <div class="cv-select-hide-item text-gray-500 text-xs whitespace-normal" data-rec="true">
                          {{ $t(option.subtitle) }}
                        </div>
                      </div>
              ...
              >
                <NcDropdown :trigger="['click']">
                  <NcButton size="xsmall" type="ghost">
                    <MdiDotsVertical
                      class="text-gray-600 h-5.5 w-5.5 rounded outline-0 p-0.5 cv-workspace-menu transform transition-transform !text-gray-400 cursor-pointer hover:(!text-gray-500 bg-gray-100)"
                    />
                  </NcButton>
            ...
            <template #entity-preview>
              <span>
                <div class="flex flex-row items-center py-2.25 px-2.5 bg-gray-50 rounded-lg text-gray-700 mb-4">
                  <GeneralIcon icon="account" class="cv-view-icon"></GeneralIcon>
                  <div
