...
import type { ApiTokenType, RequestParams } from 'clairview-sdk'
...
<template>
  <div class="flex flex-col">
    ...
    <div class="cv-content-max-w p-6 h-[calc(100vh_-_100px)] flex flex-col gap-6 overflow-auto cv-scrollbar-thin">
      <div class="max-w-202 mx-auto h-full w-full" data-testid="cv-token-list">
        ...
        <div v-if="!isLoadingAllTokens && (tokens.length || showNewTokenModal)" class="mt-6 h-full max-h-[calc(100%-80px)]">
          <div class="h-full w-full overflow-y-auto rounded-md">
            ...
            <div class="cv-scrollbar-md !overflow-y-auto flex flex-col h-[calc(100%-52px)]">
              <div v-if="showNewTokenModal">
                <div
                  class="flex gap-5 px-3 py-2.5 text-gray-500 font-medium text-3.5 w-full cv-token-generate border-b-1 border-l-1 border-r-1"
                  :class="{
              ...
              >
                ...
                <div class="flex justify-end items-center gap-3 pr-5 text-gray-500 font-medium text-3.5 w-2/9">
                  <NcTooltip placement="top">
                    ...
                    <component
                      :is="iconMap.eye"
                      class="cv-toggle-token-visibility hover::cursor-pointer w-h-4 mb-[1.8px]"
                  ...
                  <NcTooltip placement="top">
                    ...
                    <component
                      :is="iconMap.delete"
                      data-testid="cv-token-row-action-icon"
                      class="cv-delete-icon hover::cursor-pointer w-4 h-4"
        ...
        <template #entity-preview>
          <span>
            <div class="flex flex-row items-center py-2.25 px-2.5 bg-gray-50 rounded-lg text-gray-700 mb-4">
              <GeneralIcon icon="key" class="cv-view-icon"></GeneralIcon>
              <div
