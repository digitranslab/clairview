...
<template>
  <div class="flex flex-col" data-testid="cv-setup-list">
    <NcPageHeader>
      <template #title>
        <span data-rec="true">
          {{ category }}
      ...
      <div class="w-full">
        ...
        <div class="container">
          <div
            ...
            :key="app.title"
            class="item group"
            :data-testid="`cv-setup-list-item-${app.title}`"
            @click="selectApp(app)"
          >
            ...
            <GeneralIcon
              ...
              class="text-success min-w-5 h-5 bg-white-500 cv-configured"
            />
            ...
            <NcDropdown :trigger="['click']" overlay-class-name="!rounded-md" @click.stop>
              <GeneralIcon
                ...
                class="min-w-5 h-5 bg-white-500 text-gray-500 hover:text-current cv-setup-plugin-menu"
              />

              <template #overlay>
                <NcMenu class="min-w-20">
                  <NcMenuItem data-testid="cv-config-reset" @click.stop="showResetPluginModal(app)">
    ...
    <a-modal
      ...
      centered
      :footer="null"
      wrap-class-name="cv-modal-plugin-reset-conform"
    >
      <div class="flex flex-col h-full">
        ...
        <div class="flex mt-6 justify-end space-x-2">
          ...
          <NcButton size="small" type="danger" data-testid="cv-reset-confirm-btn" @click="resetPlugin">
