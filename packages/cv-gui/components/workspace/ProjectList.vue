...
import { ProjectRoles, ProjectStatus, WorkspaceUserRoles, timeAgo } from 'clairview-sdk'
    ...
    >
      ...
      <div v-else class="flex flex-col items-center gap-y-5">
        ...
        <template v-if="activePage === 'workspace'">
          <div class="font-medium text-xl">Welcome to clairView</div>
    ...
    >
      ...
      <template #bodyCell="{ column, text, record, index: i }">
        <template v-if="column.dataIndex === 'title'">
          <div class="flex items-center cv-base-title gap-2.5 max-w-full -ml-1.5">
            ...
            <!--            <div v-if="!record.edit" class="cv-click-transition-1" @click.stop> -->
        ...
        <template v-if="column.dataIndex === 'id'">
          ...
          >
            <div @click.stop>
              ...
              <GeneralIcon v-else icon="threeDotVertical" class="outline-0 cv-workspace-menu cv-click-transition" />
            </div>
            <template #overlay>
              <a-menu>
                <a-menu-item @click="enableEdit(i)">
                  <div class="cv-menu-item-wrapper">
                ...
                >
                  <div class="cv-menu-item-wrapper text-red-500">
