...
<template>
  <NcModal
    ...
    :wrap-class-name="
      aiMode ? 'cv-modal-ai-base-create' : `cv-modal-wrapper ${aiMode === null ? 'cv-ai-select-base-create-mode-modal' : ''}`
    "
  >
        ...
        >
          <a-form-item name="title" :rules="nameValidationRules" class="!mb-0">
            <a-input
              ...
              name="title"
              class="cv-metadb-base-name cv-input-sm cv-input-shadow"
              placeholder="Title"
            />
          </a-form-item>
        </a-form>
...
<style lang="scss">
.cv-modal-ai-base-create .ant-modal-content {
  .cv-modal {
    @apply !p-0;
...
.cv-modal-wrapper.cv-ai-select-base-create-mode-modal {
  .ant-modal-content {
    @apply !rounded-[24px];
  }
}
