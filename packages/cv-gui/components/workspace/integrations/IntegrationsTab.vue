...
import { IntegrationCategoryType } from 'clairview-sdk'
...
<template>
  <component
    ...
    wrap-class-name="cv-modal-available-integrations-list"
    @keydown.esc="isAddNewIntegrationModalOpen = false"
  >
    <a-layout>
      <a-layout-content class="cv-integration-layout-content">
        ...
        >
            ...
            >
              <div class="flex-1">
                <div class="text-sm font-normal text-gray-600 mb-2">
                  <div>
                    Connect integrations with ClairView.
                    <a href="https://docs.clairview.com/category/integrations" target="_blank" rel="noopener noreferrer"
                      >Learn more</a
                    >
                  </div>
                </div>
                <div class="flex items-center gap-2 !max-w-[400px]">
                  <a-input
                    ...
                    type="text"
                    class="flex-1 cv-input-border-on-value cv-search-integration-input !min-w-[300px] cv-input-sm flex-none"
                    ...
                    <NcButton size="small" type="secondary">
                      <div class="flex items-center gap-2">
                        ...
                        <div
                          ...
                          class="bg-cv-bg-brand text-cv-content-brand p-1 text-xs rounded-md min-w-6"
                        >
          ...
          <div
            ...
            class="flex-1 px-6 pb-6 flex flex-col cv-workspace-settings-integrations-list overflow-y-auto cv-scrollbar-thin"
          >
            <div
          ...
          <div v-show="requestIntegration.isOpen" class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-2">
              <a-textarea
                ...
                class="!rounded-md !text-sm !min-h-[120px] max-h-[500px] cv-scrollbar-thin"
                size="large"
                hide-details
...
.cv-integration-layout-sidebar {
  ...
  .cv-integration-category-item {
    ...
    .cv-integration-category-item-icon-wrapper {
      @apply flex-none w-5 h-5 flex items-center justify-center rounded;

      .cv-integration-category-item-icon {
        @apply flex-none w-4 h-4;
      }
    }

    .cv-integration-category-item-content-wrapper {
      @apply flex-1 flex flex-col gap-1;

      .cv-integration-category-item-title {
        @apply text-sm text-gray-800 font-weight-500;
      }

      .cv-integration-category-item-subtitle {
...
.source-card-link {
  ...
  .cv-new-integration-type-title {
    @apply text-sm font-weight-600 text-gray-600;
  }
}

.cv-workspace-settings-integrations-list {
...
<style lang="scss">
.cv-modal-available-integrations-list {
  .cv-modal {
    @apply !p-0;
