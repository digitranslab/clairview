...
<template>
  <div v-if="currentWorkspace" class="flex w-full flex-col cv-workspace-integrations">
    <div class="flex gap-2 items-center min-w-0 p-2 h-[var(--topbar-height)] border-b-1 border-gray-200">
      <div class="flex-1 cv-breadcrumb cv-no-negative-margin pl-1">
    ...
    <NcTabs v-model:activeKey="activeViewTab">
      ...
      <template v-if="isUIAllowed('workspaceIntegrations')">
        <a-tab-pane key="integrations" class="w-full">
          <template #tab>
            <div class="tab-title" data-testid="cv-workspace-settings-tab-integrations">
