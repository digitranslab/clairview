...
import { integrationCategoryNeedDefault } from 'clairview-sdk'
import type { IntegrationType, UserType, WorkspaceUserType } from 'clairview-sdk'
...
<template>
  <div class="h-full flex flex-col gap-6 cv-workspace-connections">
    <div class="flex flex-col justify-between gap-2 mx-1">
      <div class="text-sm font-normal text-gray-600">
        <div>
          Manage connections for your integrations.
          <a target="_blank" href="https://docs.clairview.com/integrations/actions-on-connection" rel="noopener noreferrer">
            Learn more
          </a>
        </div>
      </div>
      <div class="flex items-center gap-3">
        <a-input
          ...
          type="text"
          class="cv-search-integration-input !min-w-[300px] !max-w-[400px] cv-input-sm flex-none"
    ...
    <div class="table-container relative flex-1">
      <div
        ref="tableWrapper"
        class="cv-workspace-integration-table relative cv-scrollbar-thin !overflow-auto max-h-[calc(100%_-_40px)]"
        :class="{
    ...
    <NcModal v-model:visible="successConfirmModal.isOpen" centered size="small" @keydown.esc="successConfirmModal.isOpen = false">
      <div class="flex gap-4">
        ...
        <div class="flex flex-col gap-3">
          ...
          <a target="_blank" href="https://docs.clairview.com/data-sources/connect-to-data-source/" rel="noopener noreferrer">
            Learn more
          </a>
        </div>
      </div>
...
.table-container {
  ...
  .cv-workspace-integration-table {
    &.sticky-shadow {
      th,
      td {
        &.cell-title {
