...
<template>
  <div v-if="activeIntegration" class="h-full">
    ...
    <div class="h-[calc(100%_-_66px)] flex">
      <div class="cv-edit-or-add-integration-left-panel cv-scrollbar-thin relative !px-4">
        <div class="w-full gap-4 max-w-[784px]">
          <div class="cv-edit-or-add-integration bg-white relative flex flex-col justify-center gap-2 w-full">
