...
import { IntegrationsType, validateAndExtractSSLProp } from 'clairview-sdk'
import {
  type CertTypes,
  ClientType,
...
const handleUpdateAdvancedOptionsExpansionPanel = (open: boolean) => {
  if (open) {
    ...
    handleAutoScroll(true, 'cv-connection-advanced-options')
  } else {
...
function handleAutoScroll(scroll: boolean, className: string) {
  if (scroll) {
    ...
    nextTick(() => {
      const el = document.querySelector(`.cv-edit-or-add-connection .${className}`)
...
<template>
  <div v-if="activeIntegration" class="h-full">
      ...
      <div class="flex items-center gap-3">
        ...
        <NcTooltip :disabled="!testConnectionError">
          ...
          <NcButton
            type="secondary"
            size="small"
            class="cv-extdb-btn-test-connection"
    ...
    <div class="h-[calc(100%_-_66px)] flex">
      <div class="cv-edit-or-add-integration-left-panel cv-scrollbar-thin relative">
        <div class="w-full gap-8 max-w-[768px]">
          <div class="cv-edit-or-add-connection bg-white relative flex flex-col justify-center gap-2 w-full">
            <a-form
              ref="form"
              :model="formState"
              hide-required-mark
            ...
            >
              <div class="cv-form-section">
                <div class="cv-form-section-title">General</div>
              ...
              <div class="cv-form-section">
                <div class="flex items-center justify-between">
                  <div class="cv-form-section-title">Connection details</div>
                  ...
                  >
                    <NcButton
                      type="text"
                      size="small"
                      class="cv-extdb-btn-import-url !rounded-md !px-2 flex-none -my-1.5"
                    ...
                    <template #overlay>
                      <div class="p-4 w-[448px] flex flex-col gap-3">
                        ...
                        <a-textarea
                          ...
                          class="!rounded-lg !min-h-[120px] !max-h-[250px] cv-scrollbar-thin"
                        ></a-textarea>
                    ...
                    <a-col :span="12">
                      <a-form-item :label="$t('labels.dbType')" v-bind="validateInfos['dataSource.client']">
                        <NcSelect
                          ...
                          class="cv-select-shadow cv-extdb-db-type"
                          dropdown-class-name="cv-dropdown-ext-db-type"
                    ...
                    <a-row :gutter="24">
                      ...
                      <a-col :span="12">
                        ...
                        <a-form-item
                          ...
                          class="cv-form-item-connection-password"
                  ...
                  <template v-else>
                    ...
                    >
                      <a-col :span="24">
                        ...
                        <a-form-item
                          class="cv-form-extra-connectin-parameters mb-2"
                ...
                <a-collapse v-model:active-key="useSslExpansionPanel" ghost class="!mt-4">
                  ...
                  <a-collapse-panel key="1" collapsible="disabled">
                    <template #header>
                      <div class="flex">
                        <div
                          class="cv-form-section-title cursor-pointer"
                        ...
                        <a-col :span="12">
                          <a-form-item label="SSL mode">
                            <NcSelect
                              ...
                              class="cv-select-shadow"
                              dropdown-class-name="cv-dropdown-ssl-mode"
              ...
              <template
                v-if="![ClientType.SQLITE, ClientType.SNOWFLAKE, ClientType.DATABRICKS].includes(formState.dataSource.client)"
              >
                <a-collapse v-model:active-key="advancedOptionsExpansionPanel" ghost class="cv-connection-advanced-options !mt-4">
                  <template #expandIcon="{ isActive }">
                    <NcButton
                      type="text"
                      size="small"
                    ...
                    >
                      <div class="cv-form-section-title">Advanced options</div>
                  ...
                  <a-collapse-panel key="1" collapsible="disabled">
                    ...
                    <div class="flex flex-col gap-2">
                      ...
                      <div class="border-1 border-gray-200 !rounded-lg shadow-sm overflow-hidden">
                        <MonacoEditor v-model="customJsonFormState" class="cv-connection-json-editor h-[400px] w-full" />
                      </div>
                    </div>
                  </a-collapse-panel>
                </a-collapse>
      ...
      <div class="cv-edit-or-add-integration-right-panel">
...
.cv-edit-or-add-connection {
  ...
  .cv-form-extra-connectin-parameters {
    :deep(.ant-input) {
