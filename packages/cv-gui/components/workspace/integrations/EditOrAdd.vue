...
<template>
  <NcModal
    ...
    size="large"
    wrap-class-name="cv-modal-edit-or-add-integration"
...
<style lang="scss">
.cv-modal-edit-or-add-integration {
  .cv-modal {
    @apply !p-0;
    height: min(calc(100vh - 100px), 1024px);
    max-height: min(calc(100vh - 100px), 1024px) !important;

    .cv-edit-or-add-integration-left-panel {
      @apply w-full p-6 flex-1 flex justify-center;
    }
    .cv-edit-or-add-integration-right-panel {
