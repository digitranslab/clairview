...
<template>
  <div class="flex flex-row flex-grow pl-0.5 pr-1 py-0.5 rounded-md w-full" style="max-width: calc(100% - 2.5rem)">
    <div class="flex-grow min-w-20">
      <div
        data-testid="cv-workspace-menu"
        class="flex items-center cv-workspace-menu overflow-hidden py-1.25 pr-0.25 justify-center w-full ml-2"
      >
        <a
        ...
        >
          <NcTooltip :disabled="!appInfo?.version || isEeUI">
            ...
            <img alt="ClairView" src="~/assets/img/brand/clairview.png" />
          </NcTooltip>
        </a>
