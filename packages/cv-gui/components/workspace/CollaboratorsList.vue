...
import { OrderedWorkspaceRoles, WorkspaceUserRoles } from 'clairview-sdk'
...
<template>
  <div
    class="cv-collaborator-table-container py-6 max-w-350 px-6 flex flex-col gap-6"
    :class="{
  ...
  >
    <div class="w-full flex items-center justify-between gap-3">
      ...
      <NcButton size="small" :disabled="isCollaboratorsLoading" data-testid="cv-add-member-btn" @click="inviteDlg = true">
    ...
    <div class="flex h-[calc(100%-4rem)]">
      <NcTable
        ...
        :bordered="false"
        class="flex-1 cv-collaborators-list"
      >
        <template #emptyText>
              ...
              <template #overlay>
                <NcMenu>
                  <template v-if="isAdminPanel">
                    <NcMenuItem data-testid="cv-admin-org-user-delete">
