...
import { isVirtualCol } from 'clairview-sdk'
...
<template>
  ...
  >
    ...
    <div
      ...
      :class="[`cv-erd-table-node-${data.table}`, showSkeleton ? 'cursor-pointer items-center min-h-200px min-w-300px' : '']"
        ...
        <div v-for="(col, index) in data.columns" :key="col.title">
          ...
          >
            <div
              ...
              class="flex w-full"
              :class="`cv-erd-table-node-${data.table}-column-${col.title?.toLowerCase().replace(' ', '_')}`"
            >
              <Handle
              ...
              <div class="cv-erd-table-node-column flex items-center gap-2">
            ...
            <div
              ...
              class="cv-erd-table-node-column flex items-center gap-2"
              :class="`cv-erd-table-node-${data.table}-column-${col.title}`"
            >
              <SmartsheetHeaderVirtualCellIcon
                :column-meta="{
                  uidt: col.type,
