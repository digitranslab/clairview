...
<template>
  <div class="flex flex-col mx-4 h-112">
    ...
    <div class="flex flex-row mt-4 mb-2 pt-3 border-gray-100 border-t-1 gap-x-3 items-center text-xs">
      ...
      <div class="bg-gray-50 border-gray-100 border-1 py-0.5 px-1.5 rounded-md" data-testid="cv-manage-user-user-count">
        {{ totalUsers - 1 }} users
      </div>
    </div>
    <div class="flex flex-col mb-2 pr-0.5 h-96 overflow-y-auto users-list border-b-1 border-gray-100">
      ...
      <div
        ...
        :data-testid="`cv-manage-users-${user.email}`"
      >
        ...
        <a-select
          ...
          class="flex !rounded-md p-0.5 !bg-white capitalize cv-dropdown-user-role-container !min-w-26"
          dropdown-class-name="cv-dropdown-user-role !rounded-md"
        ...
        >
          <template #option="option">
            <div
              ...
              :data-testid="`cv-manage-users-role-${option.id !== 'None' ? option.name : 'Remove'}`"
            >
    ...
    <div class="flex flex-row justify-between pt-3 pb-2">
      ...
      <a-button
        ...
        data-testid="cv-manage-users-submit"
...
.cv-modal-share-collaborate .ant-select {
