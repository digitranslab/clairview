...
<template>
  <a-modal
    ...
    wrap-class-name="cv-modal-share-collaborate"
    :closable="false"
  ...
  >
    ...
    <div v-else class="flex flex-col px-1">
      ...
      <div class="share-base">
        <div class="flex flex-row items-center gap-x-2 px-4 pt-3 pb-3 select-none">
          <GeneralProjectIcon :color="parseProp(base.meta).iconColor" :type="base.type" class="cv-view-icon group-hover" />
