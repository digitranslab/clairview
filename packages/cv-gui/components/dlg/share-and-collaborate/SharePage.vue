...
import type { ColumnType, KanbanType, ViewType } from 'clairview-sdk'
    ...
    <div class="flex flex-col w-full mt-2.5 px-3 py-2.5 border-gray-200 border-1 rounded-md gap-y-2">
      ...
      <template v-if="isPublicShared">
          ...
          <template v-if="activeView?.type === ViewTypes.FORM">
            <div class="flex flex-row items-center justify-between">
              ...
              <a-switch
                ...
                data-testid="cv-modal-share-view__surveyMode"
                size="small"
              >
              </a-switch>
            </div>
            <div v-if="!isEeUI" class="flex flex-row items-center justify-between">
              ...
              <a-switch
                ...
                data-testid="cv-modal-share-view__RTL"
                size="small"
              >
              </a-switch>
            </div>
        ...
        <div
          ...
          class="cv-pre-filled-mode-wrapper flex flex-col justify-between gap-y-3 mt-1 py-2 px-3 bg-gray-50 rounded-md"
        >
          <div class="flex flex-row items-center justify-between">
            <div class="text-black flex items-center space-x-1">
              <div>
            ...
            <a-switch
              ...
              data-testid="cv-modal-share-view__preFill"
              size="small"
          ...
          <a-radio-group
            ...
            class="cv-modal-share-view-preFillMode"
            data-testid="cv-modal-share-view__preFillMode"
...
.cv-modal-share-view-preFillMode {
  @apply flex flex-col;
