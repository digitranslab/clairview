...
const syncSource = ref({
  ...
  details: {
    syncInterval: '15mins',
    syncDirection: 'Airtable to ClairView',
    syncRetryCount: 1,
    apiKey: '',
    appId: '',
    shareId: '',
...
function downloadLogs(filename: string) {
  let text = ''
  for (const o of document.querySelectorAll('.cv-modal-airtable-import .log-message')) {
    text += `${o.textContent}\n`
  }
...
<template>
  <a-modal
    ...
    class="p-2"
    wrap-class-name="cv-modal-airtable-import"
    ...
    <div class="px-5">
      ...
      <div v-if="step === 1">
        <div class="mb-4">
          ...
          <!--          Where to find this? -->
          <a
            href="https://docs.clairview.com/bases/import-base-from-airtable#get-airtable-credentials"
        ...
        <div>
          <a href="https://github.com/digitranslab/clairview/issues/2052" target="_blank" rel="noopener noreferrer">
          ...
          <div>
            ...
            <a
              class="prose-sm"
              href="https://github.com/digitranslab/clairview/discussions/2122"
              target="_blank"
