...
import { ProjectRoles, type RoleLabels, WorkspaceUserRoles } from 'clairview-sdk'
      ...
      <div class="flex w-full gap-4 flex-col">
        <div class="flex justify-between gap-3 w-full">
          <div
            ...
            class="flex items-center border-1 gap-1 w-full overflow-x-scroll cv-scrollbar-x-md items-center h-10 rounded-lg !min-w-96"
            tabindex="0"
          ...
          <RolesSelector
            ...
            :roles="allowedRoles"
            class="!min-w-[152px] cv-invite-role-selector"
            size="lg"
          />
        </div>
          ...
          <NcDropdown v-model:visible="isOrgSelectMenuOpen">
            ...
            <template #overlay>
              <div class="py-2">
                ...
                <div class="flex flex-col max-h-64 overflow-y-auto cv-scrollbar-md mt-2 px-2">
                  <div
...
:deep(.cv-invite-role-selector .cv-role-badge) {
  @apply w-full;
}
</style>
