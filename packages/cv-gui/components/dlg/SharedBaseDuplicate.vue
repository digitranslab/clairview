...
import { ProjectTypes, WorkspaceUserRoles } from 'clairview-sdk'
...
<template>
  <GeneralModal v-model:visible="dialogShow" class="!w-[30rem]" wrap-class-name="cv-modal-project-duplicate">
    <div>
