...
<template>
  <LazyVirtualCellComponentsLinkRecordDropdown v-model:is-open="isOpen">
    <div class="cv-cell-field flex w-full chips-wrapper items-center min-h-4" :class="{ active }">
      ...
      >
        <GeneralIcon
          :icon="addIcon"
          class="select-none text-gray-700 cv-action-icon cv-plus invisible group-hover:visible group-focus:visible"
          :class="{
