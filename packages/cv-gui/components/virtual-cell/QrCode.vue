...
<template>
  <a-modal
    ...
    wrap-class-name="cv-qr-code-large"
    :body-style="{ padding: '0px' }"
    @ok="handleModalOkClick"
  >
    <template #footer>
      <div class="flex flex-row">
        <div class="flex flex-row flex-grow mr-2 !overflow-y-auto py-2" data-testid="cv-qr-code-large-value-label">
          {{ qrValue }}
        </div>
  ...
  <div
    v-if="showQrCode"
    class="cv-qrcode-container w-full flex"
    :class="{
