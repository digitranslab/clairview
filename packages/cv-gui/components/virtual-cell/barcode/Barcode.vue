...
<template>
  <a-modal
    ...
    wrap-class-name="cv-barcode-large"
  ...
  <div v-if="tooManyCharsForBarcode" class="cv-cell-field text-left text-wrap text-[#e65100] text-xs">
    {{ $t('labels.barcodeValueTooLong') }}
  </div>
  <div v-if="showEditNonEditableFieldWarning" class="cv-cell-field text-left text-wrap mt-2 text-[#e65100] text-xs">
    {{ $t('msg.warning.nonEditableFields.computedFieldUnableToClear') }}
  </div>
  <div v-if="showClearNonEditableFieldWarning" class="cv-cell-field text-left text-wrap mt-2 text-[#e65100] text-xs">
