...
<template>
  <div class="cv-cell-field flex w-full group items-center cv-links-wrapper py-1" @dblclick.stop="openChildList">
      ...
      <div class="flex w-full group items-center min-h-4">
        <div class="block flex-shrink truncate">
          <component
            ...
            :title="textVal"
            class="text-center cv-datatype-link underline-transparent"
        ...
        >
          <MdiPlus
            ...
            class="select-none !text-md text-gray-700 cv-action-icon cv-plus invisible group-hover:visible group-focus:visible"
