...
<template>
  <div class="flex w-full chips-wrapper items-center" :class="{ active }">
    <LazyVirtualCellComponentsLinkRecordDropdown v-model:is-open="isOpen">
      <div class="cv-cell-field flex items-center w-full">
        ...
        >
          <GeneralIcon
            icon="plus"
            class="flex-none select-none !text-md text-gray-700 cv-action-icon cv-plus invisible group-hover:visible group-focus:visible"
