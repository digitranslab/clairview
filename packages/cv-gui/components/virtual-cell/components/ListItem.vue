...
import { UITypes, isVirtualCol, parseStringDateTime } from 'clairview-sdk'
...
<template>
  <div class="cv-list-item-wrapper group px-[1px] hover:bg-gray-50 border-y-1 border-gray-200 border-t-transparent">
    <a-card
      tabindex="0"
      class="cv-list-item !outline-none transition-all relative group-hover:bg-gray-50 cursor-auto"
      :class="{
        '!bg-white': isLoading,
        '!hover:bg-white': readOnly,
        'cv-is-selected': isSelected,
      }"
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex-1 flex flex-col gap-1 justify-center overflow-hidden">
          <div class="flex justify-start">
            <span class="font-semibold text-brand-500 cv-display-value truncate leading-[20px]">
              {{ displayValue }}
            </span>
          </div>
                ...
                <NcTooltip class="z-10 flex" placement="bottomLeft" :arrow-point-at-center="false">
                  <template #title>
                    <LazySmartsheetHeaderVirtualCell
                      ...
                      class="text-gray-100 !text-sm cv-link-record-cell-tooltip"
                      :column="field"
                      :hide-menu="true"
                    />
                  ...
                  <div class="cv-link-record-cell flex w-full max-w-full">
        ...
        <div v-if="!isForm && !isPublic && !readOnly" class="flex-none flex items-center w-7">
          <NcTooltip class="flex">
            ...
            <button
              ...
              :tabindex="-1"
              class="z-10 flex items-center justify-center cv-expand-item !group-hover:visible !invisible !h-7 !w-7 transition-all !hover:children:(w-4.5 h-4.5)"
        ...
        <template v-if="(!isPublic && !readOnly) || isForm">
          <NcTooltip class="z-10 flex">
            ...
            <button
              tabindex="-1"
              class="cv-list-item-link-unlink-btn p-1.5 flex rounded-lg transition-all"
              :class="{
