...
import InboxIcon from '~icons/cv-icons/inbox'
...
<template>
  <div class="cv-modal-link-record h-full w-full overflow-hidden" :class="{ active: vModel }" @keydown.enter.stop>
    <div class="flex flex-col h-full">
      <div class="cv-dropdown-link-record-header bg-gray-100 py-2 rounded-t-xl flex justify-between pl-3 pr-2 gap-2">
        <div class="flex-1 gap-2 flex items-center">
          ...
          <div class="flex-1 cv-dropdown-link-record-search-wrapper flex items-center py-0.5 rounded-md">
            <a-input
              ref="filterQueryRef"
              v-model:value="childrenExcludedListPagination.query"
              :bordered="false"
              placeholder="Search records to link..."
              class="w-full cv-excluded-search min-h-4 !pl-0"
              size="small"
      ...
      <div class="flex-1 overflow-auto cv-scrollbar-thin">
          ...
          <div ref="childrenExcludedListRef">
            ...
            <template v-else>
              <LazyVirtualCellComponentsListItem
                ...
                :row="refRow"
                data-testid="cv-excluded-list-item"
      ...
      <div class="cv-dropdown-link-record-footer bg-gray-100 p-2 rounded-b-xl flex items-center justify-between min-h-11">
        <div class="flex">
          <NcButton
