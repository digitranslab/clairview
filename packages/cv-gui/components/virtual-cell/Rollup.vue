...
import { UITypes, getRenderAsTextFunForUiType } from 'clairview-sdk'
import type { ColumnType, LinkToAnotherRecordType, RollupType } from 'clairview-sdk'
...
<template>
  <div class="cv-cell-field" @dblclick="activateShowEditNonEditableFieldWarning">
