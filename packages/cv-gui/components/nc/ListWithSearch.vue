...
const handleAutoScrollOption = () => {
  const option = document.querySelector('.cv-unified-list-option-active')
...
<template>
  <div
    ref="wrapperRef"
    class="flex flex-col pt-2 cv-list-with-search w-64"
  ...
  >
    <div class="w-full pb-2 px-2" @click.stop>
      <a-input
        ...
        class="cv-dropdown-search-unified-input"
    ...
    <div class="cv-unified-search-list-wrapper flex-col w-full max-h-100 cv-scrollbar-thin !overflow-y-auto px-2 pb-2">
      ...
      <div
        ...
        :class="[
          ...
          `cv-unified-list-option-${index}`,
          {
            'bg-gray-100 cv-unified-list-option-active': activeOptionIndex === index,
          },
        ]"
...
.cv-unified-search-list-wrapper {
