...
<template>
  <div class="cv-pagination flex flex-row items-center gap-x-2">
    <template v-if="totalPages > 1">
      ...
      <div v-if="!isMobileMode" class="text-gray-500">
        <a-select
          ...
          :options="pagesList"
          size="small"
          dropdown-class-name="cv-pagination-dropdown"
          @dropdown-visible-change="pageListDropdownVisibleChange"
        >
          <template #suffixIcon>
            <GeneralIcon icon="arrowDown" class="text-gray-500 cv-select-expand-btn" />
          </template>
        </a-select>
    ...
    <div v-if="showSizeChanger && !isMobileMode" class="text-gray-500">
      ...
      >
        <template #suffixIcon>
          <GeneralIcon icon="arrowDown" class="text-gray-500 cv-select-page-size-expand-btn" />
        </template>
      </a-select>
    </div>
  </div>
