...
<template>
  <div class="flex flex-col max-w-[350px]">
    <div v-if="isMinGranularityPicker" ref="timeOptionsWrapperRef" class="h-[180px] overflow-y-auto cv-scrollbar-thin">
      <div
        ...
        :class="{
          'cv-selected bg-gray-100': selectedDate && compareTime(time, selectedDate),
        }"
