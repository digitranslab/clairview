...
import { type ColumnType, isLinksOrLTAR, isSystemColumn, isVirtualCol } from 'clairview-sdk'
...
<template>
  <div class="cv-list-item-wrapper group px-[1px] hover:bg-gray-50 border-y-1 border-gray-200 border-t-transparent w-full">
    <a-card
      tabindex="0"
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="flex-1 flex flex-col gap-1 justify-center overflow-hidden">
          <div
            ...
            class="flex justify-start font-semibold text-brand-500 cv-display-value"
