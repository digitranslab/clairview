    ...
    <template v-if="isSearchEnabled">
      <div class="w-full px-2 flex items-center gap-2" @click.stop>
        ...
        <a-input
          ...
          class="cv-toolbar-dropdown-search-field-input !pl-2 !pr-1.5 flex-1"
          allow-clear
          :bordered="false"
      ...
      <template v-if="list.length">
        <div class="h-auto !max-h-[247px]">
          <div
            ...
            class="cv-list !h-auto w-full cv-scrollbar-thin px-2 pb-2 !max-h-[247px]"
            ...
            <div v-bind="wrapperProps">
              <NcTooltip
                ...
                :class="[
                  `cv-list-option-${idx}`,
                  {
                    'cv-list-option-selected': compareVModel(option[optionValueKey]),
                    'bg-gray-100 ':
                      !option?.ncItemDisabled && showHoverEffectOnSelectedOption && compareVModel(option[optionValueKey]),
                    'bg-gray-100 cv-list-option-active': !option?.ncItemDisabled && activeOptionIndex === idx,
...
:deep(.cv-toolbar-dropdown-search-field-input) {
