...
<template>
  <div class="flex flex-col">
    <div
      class="flex border-b-1 cv-month-picker-pagination justify-between items-center"
      :class="{
    ...
    >
      <div class="flex">
        <NcTooltip hide-on-click>
          <NcButton class="cv-prev-page-btn !border-0" size="small" type="text" @click="paginate('prev')">
      ...
      <span
        class="cv-year-picker-btn text-gray-700 font-semibold"
        :class="{
      ...
      <div class="flex">
        <NcTooltip hide-on-click>
          <NcButton class="cv-next-page-btn !border-0" size="small" type="text" @click="paginate('next')">
    ...
    >
      <div class="grid grid-cols-4 gap-2">
        <template v-if="!isYearPicker">
          <span
            ...
            class="cv-month-item h-8 flex items-center rounded transition-all justify-center text-gray-700 cursor-pointer"
        ...
        <template v-else>
          <span
            ...
            class="cv-year-item h-8 flex items-center rounded transition-all justify-center cursor-pointer"
      ...
      <div v-if="showCurrentDateOption" class="flex items-center justify-center px-2 pb-2 pt-1">
        <NcTooltip :disabled="showCurrentDateOption !== 'disabled'">
          ...
          <NcButton
            class="cv-date-picker-now-btn !h-7"
            size="small"
            type="secondary"
