...
<template>
  <a-button
    ...
    :class="{
      ...
      'theme-ai': theme === 'ai',
      'bordered': bordered,
      'cv-btn-shadow': shadow,
      'cv-show-as-disabled': props.showAsDisabled,
    }"
  ...
  >
    <div
      ...
      class="flex flex-row gap-x-2.5 cv-btn-inner w-full"
    >
...
.desktop {
  ...
  .cv-button.ant-btn-text.focused {
    &.theme-default {
...
.cv-button.ant-btn.xsmall {
  @apply p-0.25 h-6.25 min-w-6.25 rounded-md;
}

.cv-button.ant-btn.xxsmall {
  @apply p-0 h-5.75 min-w-5.75 rounded-md;
}

.cv-button.ant-btn[disabled],
.ant-btn-text.cv-button.ant-btn[disabled] {
...
.cv-button.ant-btn.cv-show-as-disabled,
.ant-btn-text.cv-button.ant-btn.cv-show-as-disabled {
  box-shadow: none !important;
...
.cv-button.ant-btn-text.ant-btn[disabled],
.cv-button.ant-btn-text.ant-btn.cv-show-as-disabled {
  &.theme-default,
  &.theme-ai {
...
.cv-button.ant-btn-secondary[disabled],
.cv-button.ant-btn-secondary.cv-show-as-disabled {
  @apply border-1;
...
.cv-button.ant-btn-text {
  ...
  &.theme-ai {
    @apply text-cv-content-purple-dark hover:text-cv-content-purple-dark hover:bg-cv-bg-purple-dark;
  }
