...
<template>
  <NcModal
    ...
    :footer="null"
    size="lg"
    wrap-class-name="cv-modal-extension-details"
  >
    <div v-if="activeExtension" class="flex flex-col w-full h-full">
      ...
      <div class="extension-details">
        <div class="extension-details-left">
          <div class="cv-extension-details-body" v-html="detailsBody"></div>
        </div>
        <div class="extension-details-right">
          ...
          <div v-if="activeExtension.publisher" class="extension-details-right-section">
            ...
            <div class="flex items-center gap-3 text-sm font-semibold text-cv-content-brand">
              <a
              ...
              <template v-if="activeExtension.publisher?.email">
                <div class="border-l-1 border-cv-border-gray-medium h-5"></div>
                <a
...
.extension-details {
  ...
  .extension-details-left {
    @apply p-6 flex-1 flex flex-col gap-6 cv-scrollbar-thin;
  }

  .extension-details-right {
    @apply p-5 w-[320px] flex flex-col space-y-4 border-l-1 border-gray-200 bg-gray-50 cv-scrollbar-thin;
