...
<template>
  <NcModal
    ...
    :footer="null"
    size="lg"
    wrap-class-name="cv-modal-extension-market"
  >
    <div class="h-full">
      <div class="cv-extension-market-header flex items-center gap-3 px-4 py-3 border-b-1 border-gray-200">
        <div
        ...
        <div class="flex bg-cv-bg-gray-medium rounded-lg p-1">
          <div class="flex items-center">
            <NcTooltip
              v-for="(tab, idx) of tabs"
              :key="idx"
              :disabled="tab.tabKey === 'extensions'"
              class="cv-extension-market-header-tab-item"
              :class="{
            ...
            >
              ...
              <div
                ...
                :class="{
                  'bg-white text-cv-content-gray-emphasis': activeTab === tab.tabKey,
                  'text-cv-content-gray-subtle2': activeTab !== tab.tabKey,
        ...
        <div class="flex-1 flex gap-3 justify-end">
          <div v-if="activeTab !== 'build-an-extension'" ref="searchWrapperRef" class="flex-1 flex max-w-[290px] justify-end">
            ...
            <a-input
              ...
              type="text"
              class="cv-input-border-on-value !h-8 !px-3 !py-1 !rounded-lg"
...
<style lang="scss">
.cv-modal-extension-market {
  .cv-modal {
    @apply !p-0;
  }

  .cv-extension-market-header {
    .cv-extension-market-header-tab-item {
      @apply relative;

      // Add vertical line to all items except the last one
      &:not(:last-child)::after {
        @apply absolute right-0 top-[4px] h-[16px] w-[1px] bg-cv-bg-gray-dark; // Use WindiCSS utilities for line
