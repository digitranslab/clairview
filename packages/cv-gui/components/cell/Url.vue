...
<template>
  <div class="flex flex-row items-center justify-between w-full h-full">
    ...
    <input
      ...
      :ref="focus"
      v-model="vModel"
      class="cv-cell-field outline-none w-full py-1 bg-transparent h-full"
    ...
    <nuxt-link
      ...
      no-prefetch
      no-rel
      class="py-1 z-3 underline cv-cell-field-link max-w-full"
      :to="url"
      :target="cellUrlOptions?.behavior === 'replace' ? undefined : '_blank'"
      :tabindex="readOnly ? -1 : 0"
    >
      <LazyCellClampedText :value="value" :lines="rowHeight" class="cv-cell-field" />
    </nuxt-link>
    ...
    <nuxt-link
      ...
      no-prefetch
      no-rel
      class="py-1 z-3 w-full h-full text-center !no-underline cv-cell-field-link max-w-full"
      :to="url"
      :target="cellUrlOptions?.behavior === 'replace' ? undefined : '_blank'"
      :tabindex="readOnly ? -1 : 0"
    >
      <LazyCellClampedText :value="cellUrlOptions.overlay" :lines="rowHeight" class="cv-cell-field" />
    </nuxt-link>
