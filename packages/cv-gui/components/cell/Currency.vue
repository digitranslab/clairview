...
<template>
  <div
    ...
    class="cv-currency-code h-full !bg-gray-100 border-r border-gray-200 px-3 mr-1 flex items-center"
  >
    <span>
  ...
  <input
    ...
    v-model="vModel"
    type="number"
    class="cv-cell-field h-full border-none rounded-md py-1 outline-none focus:outline-none focus:ring-0"
  ...
  <span v-else-if="!isNaN(vModel)" class="cv-cell-field">{{ currency }}</span>
