import type { AttachmentReqType, AttachmentType } from 'clairview-sdk'
import { populateUniqueFileName } from 'clairview-sdk'
import DOMPurify from 'isomorphic-dompurify'
import RenameFile from './RenameFile.vue'
import MdiPdfBox from '~icons/cv-icons-v2/file-type-pdf'
import MdiFileWordOutline from '~icons/cv-icons-v2/file-type-word'
import MdiFilePowerpointBox from '~icons/cv-icons-v2/file-type-presentation'
import MdiFileExcelOutline from '~icons/cv-icons-v2/file-type-csv'
import IcOutlineInsertDriveFile from '~icons/cv-icons-v2/file-type-unknown'
