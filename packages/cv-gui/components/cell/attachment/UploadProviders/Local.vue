...
<template>
  ...
  >
    ...
    >
      ...
      <template v-else>
        <div
          class="grid overflow-y-auto flex-grow-1 cv-scrollbar-md grid-cols-4 w-full h-full items-start py-2 justify-center gap-4"
        >
    ...
    <div v-if="tempFiles.length" class="flex gap-2 pt-2 bg-white w-full items-center justify-end">
      ...
      <NcButton :loading="isLoading" data-testid="cv-upload-file" size="small" @click="emits('upload', tempFiles)">
