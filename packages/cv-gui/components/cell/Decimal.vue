...
import { roundUpToPrecision } from 'clairview-sdk'
...
<template>
  ...
  <input
    ...
    :ref="focus"
    v-model="vModel"
    class="cv-cell-field outline-none py-1 border-none rounded-md w-full h-full"
    type="number"
    :step="precision"
  ...
  <span v-else class="cv-cell-field">{{ displayValue }}</span>
</template>
