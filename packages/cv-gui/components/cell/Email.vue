...
<template>
  ...
  <input
    ...
    :ref="focus"
    v-model="vModel"
    class="cv-cell-field w-full outline-none py-1"
  ...
  <nuxt-link
    ...
    no-ref
    class="py-1 underline inline-block cv-cell-field-link max-w-full"
    :href="`mailto:${vModel}`"
    target="_blank"
    :tabindex="readOnly ? -1 : 0"
  >
    <LazyCellClampedText :value="vModel" :lines="rowHeight" class="cv-cell-field" />
  </nuxt-link>

  <LazyCellClampedText v-else :value="vModel" :lines="rowHeight" class="cv-cell-field" />
</template>
