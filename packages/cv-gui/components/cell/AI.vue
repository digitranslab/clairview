...
import type { AIRecordType, ButtonType, ColumnType } from 'clairview-sdk'
...
<template>
  ...
  >
    <NcTooltip :disabled="isFieldAiIntegrationAvailable || isPublic || isUIAllowed('dataEdit')" class="flex">
      ...
      <button class="cv-cell-ai-button cv-cell-button h-6" size="small" :disabled="isDisabledAiButton" @click.stop="generate">
