...
import type { GeoLocationType } from 'clairview-sdk'
...
<template>
  <a-dropdown :is="isExpanded ? AModal : 'div'" v-model:visible="isExpanded" :trigger="['click']">
    <div
      ...
      tabindex="0"
    >
      <div class="flex items-center gap-2" data-testid="cv-geo-data-set-location-button">
        <component
    ...
    <div
      v-else
      data-testid="cv-geo-data-lat-long-set"
      tabindex="0"
      class="cv-cell-field h-full w-full flex items-center py-1 focus-visible:!outline-none focus:!outline-none"
    >
      {{ latLongStr }}
    </div>
    <template #overlay>
      <a-form :model="formState" class="flex flex-col w-max-64 border-1 border-gray-200" @finish="handleFinish">
        <a-form-item>
          <div class="flex mt-4 items-center mx-2">
            ...
            <a-input
              ...
              data-testid="cv-geo-data-latitude"
              type="number"
              step="0.0000001"
              :min="-90"
              required
        ...
        <a-form-item>
          <div class="flex items-center mx-2">
            ...
            <a-input
              ...
              data-testid="cv-geo-data-longitude"
              type="number"
              step="0.0000001"
              required
              :min="-180"
        ...
        <a-form-item>
          <div class="ml-auto mr-2 w-auto">
            ...
            <a-button type="primary" html-type="submit" data-testid="cv-geo-data-save" class="!rounded-lg">{{
              $t('general.submit')
            }}</a-button>
          </div>
        </a-form-item>
