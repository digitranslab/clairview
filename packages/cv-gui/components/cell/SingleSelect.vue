...
import type { SelectOptionType } from 'clairview-sdk'
...
<template>
  <div
    class="cv-cell-field h-full w-full flex items-center cv-single-select focus:outline-transparent"
  ...
  >
    ...
    <template v-else>
      ...
      <NcSelect
        ...
        :dropdown-class-name="`cv-dropdown-single-select-cell !min-w-156px ${isOpen && active ? 'active' : ''}`"
...
.cv-single-select:not(.read-only) {
