...
<template>
  ...
  >
    <div
      v-if="!justDeleted"
      ref="wrapperRef"
      class="relative bubble-menu cv-text-area-rich-link-options bg-white flex flex-col border-1 border-gray-200 py-1 px-1 rounded-lg w-full"
      data-testid="cv-text-area-rich-link-options"
      ...
      <div class="flex items-center gap-x-1">
        <div class="!py-0.5 bg-white rounded-md !z-10 flex-1">
          <a-input
            ...
            v-model:value="href"
            :tabindex="tabIndex"
            class="cv-text-area-rich-link-option-input flex-1 !mx-0.5 !px-1.5 !py-0.5 !rounded-md z-10"
            :bordered="false"
        ...
        <NcTooltip overlay-class-name="cv-text-area-rich-link-options">
          ...
          <NcButton
            ...
            data-testid="text-gray-700 cv-text-area-rich-link-options-open-link"
            size="small"
            type="text"
            @click="openLink"
          >
        ...
        <NcTooltip overlay-class-name="cv-text-area-rich-link-options">
          ...
          <NcButton
            ...
            data-testid="cv-text-area-rich-link-options-open-delete"
            size="small"
            type="text"
            @click="onDelete"
          >
...
.cv-text-area-rich-link-option-input {
  @apply !placeholder:text-gray-500 text-gray-800;
}

.cv-text-area-rich-link-options {
