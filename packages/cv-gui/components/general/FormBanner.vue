...
import type { AttachmentResType } from 'clairview-sdk'
...
<template>
  <div
    class="cv-form-banner-wrapper w-full mx-auto rounded-2xl overflow-hidden"
  ...
  >
    <LazyCellAttachmentPreviewImage
      ...
      class="cv-form-banner-image object-cover w-full"
    />
