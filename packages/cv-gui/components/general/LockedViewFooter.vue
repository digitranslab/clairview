...
import { ViewLockType, type ViewType } from 'clairview-sdk'
...
<template>
  <div
    class="cv-locked-view-footer flex items-center gap-1 bg-cv-bg-gray-light pl-3 pr-2 py-1.5 text-cv-content-gray-subtle2 text-small leading-[18px]"
  >
    <component
    ...
    <NcButton
      ...
      type="text"
      size="xs"
      class="!text-cv-content-brand !hover:bg-cv-bg-gray-medium"
