...
<template>
  <div class="cv-advance-color-picker w-[336px] pt-2" click.stop>
    <NcTabs v-model:activeKey="isDefaultColorTab" class="cv-advance-color-picker-tab w-full">
      <a-tab-pane key="true">
        <template #tab>
          <div class="tab" data-testid="cv-default-colors-tab">Default colors</div>
        </template>
      ...
      <a-tab-pane key="false">
        <template #tab>
          <div class="tab" data-testid="cv-custom-colors-tab">
