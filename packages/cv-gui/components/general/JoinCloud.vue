...
<template>
  <div class="flex flex-row items-center w-full bg-white rounded-lg border-1 border-brand-500 shadow-sm mb-0.5 overflow-hidden">
    <a
      ...
      href="https://app.clairview.com/#/signin?utm_source=OSS&utm_medium=OSS&utm_campaign=OSS&utm_content=OSS"
    >
      <div class="px-1 text-gray-500 prose-sm" style="line-height: 1.3125rem">Try ClairView Cloud</div>
    </a>
    <a-tooltip overlay-class-name="cv-join-cloud-tooltip">
      <template #title>
        <div class="w-72 bg-transparent overflow-hidden rounded-3xl shadow border border-zinc-100">
          <div class="p-6 bg-white flex-col justify-start items-center gap-4 inline-flex pb-7 w-full">
            <div class="self-stretch justify-start items-center gap-3 inline-flex">
              <div class="text-slate-800 text-lg font-semibold leading-9">ClairView Cloud</div>
            ...
            <a href="https://app.clairview.com/#/signin" target="_blank" class="!no-underline" rel="noopener">
