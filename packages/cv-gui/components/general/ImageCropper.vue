...
import type { AttachmentReqType, PublicAttachmentScope } from 'clairview-sdk'
...
<template>
  <NcModal v-model:visible="showCropper" :mask-closable="false" wrap-class-name="!z-1050">
    <div class="cv-image-cropper-wrapper relative">
      <Cropper
        ref="cropperRef"
        class="cv-cropper relative"
        :src="imageConfig.src"
        :auto-zoom="true"
