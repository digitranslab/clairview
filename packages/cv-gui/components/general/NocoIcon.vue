...
<template>
  ...
  >
    <div class="relative">
      <img class="hidden dark:block" :width="size" :height="size" alt="ClairView" src="~/assets/img/icons/256x256-trans.png" />
      <img class="dark:hidden" :width="size" :height="size" alt="ClairView" src="~/assets/img/icons/256x256.png" />
