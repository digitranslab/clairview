...
<template>
  <div>
    <div class="p-1 w-[280px] h-[280px] flex flex-col gap-1 justify-start cv-emoji" data-testid="cv-emoji-container">
      <div @click.stop>
        <input
          v-model="search"
          data-testid="cv-emoji-filter"
      ...
      <div class="flex gap-1 flex-wrap w-full flex-shrink overflow-y-auto scrollbar-thin-dull">
        <div v-for="icon of filteredIcons" :key="icon" @click="selectIcon(icon)">
          <span class="cursor-pointer cv-emoji-item">
