...
<template>
  <div>
    <a-dropdown v-model:visible="isOpen" :trigger="['click']" :disabled="readonly">
      <div
        class="flex flex-row justify-center items-center select-none rounded-md cv-base-icon-picker-trigger"
        :class="{
      ...
      <template #overlay>
        <div
          class="cv-base-icon-color-picker-dropdown relative bg-white rounded-lg border-1 border-gray-200 overflow-hidden max-w-[342px]"
        >
          <div class="flex justify-start">
            <GeneralColorPicker
              ...
              :is-new-design="true"
              class="cv-base-icon-color-picker"
...
.cv-base-icon-color-picker-dropdown {
