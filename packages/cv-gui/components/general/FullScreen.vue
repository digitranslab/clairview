...
const rightSidebar = useSidebar('cv-right-sidebar')

const leftSidebar = useSidebar('cv-left-sidebar')
...
<template>
  <a-tooltip placement="left">
    ...
    <div
      ...
      class="cv-fullscreen-btn cursor-pointer flex align-center self-center px-2 py-2 mr-2"
