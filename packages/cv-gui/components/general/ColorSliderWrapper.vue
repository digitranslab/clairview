...
<template>
  <Slider
    v-model="picked"
    class="cv-color-slider-wrapper min-w-[200px]"
    :style="{
      '--cv-color-slider-pointer': tinycolor(`hsv(${picked.h ?? 199}, 100%, 100%)`).toHexString(),
    }"
  />
</template>

<style lang="scss" scoped>
.cv-color-slider-wrapper {
  &.vc-slider {
    @apply !w-full;
  }
  ...
  :deep(.vc-slider-hue-warp) {
    ...
    .vc-hue-picker {
      ...
      box-shadow: 0 0 0 3px var(--cv-color-slider-pointer) !important;
    }
  }
}
</style>
