...
<template>
  <div v-if="releaseAlert && !appInfo.ee" class="flex items-center">
    <a-dropdown :trigger="['click']" placement="bottom" overlay-class-name="cv-dropdown-upgrade-menu">
      ...
      <template #overlay>
        <div class="mt-1 bg-white shadow-lg !border">
          <nuxt-link
            ...
            to="https://github.com/digitranslab/clairview/releases"
            target="_blank"
          >
            <div class="cv-menu-item">
          ...
          <nuxt-link
            ...
            rel="noopener"
            class="!text-primary !no-underline"
            to="https://docs.clairview.com/getting-started/upgrading"
            target="_blank"
          >
            <div class="cv-menu-item">
          ...
          <div class="cv-menu-item" @click="releaseAlert = false">
            <mdi-close />
            <!-- Hide menu -->
            {{ $t('general.hideMenu') }}
          </div>
