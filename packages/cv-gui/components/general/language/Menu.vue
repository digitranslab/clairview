...
<template>
  <a-menu-item class="group rounded-md !my-0.5">
    <a
      href="https://docs.clairview.com/engineering/translation/#how-to-contribute--for-community-members"
      target="_blank"
      class="caption cv-base-menu-item rounded-md underline hover:!text-primary"
      rel="noopener"
    >
  ...
  >
    <div class="flex items-center gap-2 justify-between">
      <div class="cv-base-menu-item w-fit capitalize">
        {{ Language[key] || lang }}
      </div>
