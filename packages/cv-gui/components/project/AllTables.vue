...
import type { SourceType, TableType } from 'clairview-sdk'
...
<template>
  <div class="cv-all-tables-view px-6 pt-6">
    <div
      class="flex flex-row gap-x-6 pb-2 overflow-x-auto cv-scrollbar-thin"
      :class="{
    ...
    >
      <div
        ...
        role="button"
        class="cv-base-view-all-table-btn"
    ...
    >
      <NcTable
        ...
        :bordered="false"
        class="cv-base-view-all-table-list flex-1"
      >
...
.cv-base-view-all-table-btn.disabled {
