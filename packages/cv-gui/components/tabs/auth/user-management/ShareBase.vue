...
<template>
  <div class="flex flex-col gap-2 w-full" data-testid="cv-share-base-sub-modal">
    ...
    <div class="flex flex-row justify-between mx-1">
      <a-dropdown v-model="showEditBaseDropdown" class="flex" overlay-class-name="cv-dropdown-shared-base-toggle">
        <a-button>
          <div class="flex flex-row rounded-md items-center space-x-2 cv-disable-shared-base">
      ...
      <a-select
        ...
        class="flex cv-shared-base-role"
        dropdown-class-name="cv-dropdown-share-base-role"
      >
        <template #suffixIcon>
    ...
    >
      <span class="flex text-xs overflow-x-hidden overflow-ellipsis text-gray-700 pl-2 cv-url">{{ url }}</span>
