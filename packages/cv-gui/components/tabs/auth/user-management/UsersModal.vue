...
import { ProjectRoles, RoleColors } from 'clairview-sdk'
import type { ProjectUserReqType } from 'clairview-sdk'
                ...
                <div class="flex flex-col w-1/4">
                  <a-form-item name="role" :rules="[{ required: true, message: t('msg.roleRequired') }]">
                    ...
                    <a-select
                      ...
                      size="middle"
                      class="cv-user-roles !rounded-md"
                      dropdown-class-name="cv-dropdown-user-role"
                    >
                      <a-select-option v-for="(role, index) in ProjectRoles" :key="index" :value="role" class="cv-role-option">
