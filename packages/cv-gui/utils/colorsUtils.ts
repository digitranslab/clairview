 ...
 * ```html
 * <p class="text-cv-content-grey-subtle">This is subtle grey text.</p>
 * ```
 *
 * ###### Border Color
 * To apply a border color, you can use:
 * ```html
 * <div class="border-cv-border-gray-light">This div has a light grey border.</div>
 * ```
 *
 * ###### Background Color
 * To apply a background color, you can use:
 * ```html
 * <div class="bg-cv-bg-brand">This div has a brand color background.</div>
 * <div class="bg-cv-bg-blue-dark">This div has a blue dark color background.</div>
 * ```
 *
 * ###### Fill Color
 ...
 * - **SVG Fill**:
 * ```html
 * <svg class="fill-cv-fill-primary">...</svg>
 * ```
 * - **Text Color**:
 * ```html
 * <p class="text-cv-fill-red-dark">...</p>
 * ```
 * - **Border Color**:
 * ```html
 * <div class="border-cv-fill-primary">...</div>
 * ```
 * - **Background Color**:
 * ```html
 * <div class="bg-cv-fill-primary-hover">...</div>
 * ```
...
export const lightTheme = {
  ...
  background: {
    'cv-bg-default': themeV3Colors.base.white,
    'cv-bg-brand': themeV3Colors.brand[50],
    'cv-bg-gray': {
  ...
  border: {
    'cv-border-brand': themeV3Colors.brand[500],
    'cv-border-gray': {
      extralight: themeV3Colors.gray[50],
      light: themeV3Colors.gray[100],
      medium: themeV3Colors.gray[200],
