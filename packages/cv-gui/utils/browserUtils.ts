...
export const isLinkDropdownExist = () => document.querySelector('.cv-links-dropdown.active')
export const isDrawerOrModalExist = () => document.querySelector('.ant-modal.active, .ant-drawer-open')
export const isExpandedFormOpenExist = () => document.querySelector('.cv-drawer-expanded-form.active')
...
export const isFieldEditOrAddDropdownOpen = () => document.querySelector('.cv-dropdown-edit-column.active')
