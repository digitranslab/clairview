Data Exporter extension is designed to simplify the process of exporting data from your ClairView tables. With just a few clicks, you can effortlessly download CSV files for any specific table and view within your base.
</br> </br>
...
Elevate your data handling capabilities with the ClairView Data Exporter extension!
</br></br>

<!-- Todo: Add docs link -->
<a href="https://docs.clairview.com/extensions/data-exporter" target="_blank" rel="noopener noreferrer" class="!no-underline !hover:underline inline-flex items-center gap-2">
    Learn more
