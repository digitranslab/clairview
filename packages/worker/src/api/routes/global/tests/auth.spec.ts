import { CloudAccount, SSOUser, User } from "@clairview/types"
...
import { events, constants } from "@clairview/backend-core"
        ...
        describe("root account sso user", () => {
          it("should prevent user from generating password reset email", async () => {
            ...
            const account: CloudAccount = {
              ...
              clairviewUserId: "clairviewUserId",
              email: user.email,
            }
