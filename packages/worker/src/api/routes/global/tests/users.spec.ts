import { InviteUsersResponse, User } from "@clairview/types"

import { TestConfiguration, mocks, structures } from "../../../../tests"
import { events, tenancy, accounts as _accounts } from "@clairview/backend-core"
  ...
  describe("POST /api/global/users (update)", () => {
    ...
    describe("sso users", () => {
      ...
      it("if user email doesn't exist, SSO support couldn't be added. Not found error returned", async () => {
        const ssoId = "fake-ssoId"
        const email = "fake-email@clairview.com"
        await config.api.users
