...
import { helpers } from "@clairview/shared-core"

import tk from "timekeeper"
import { EmailAttachment } from "@clairview/types"
  ...
  async function sendRealEmail(
    ...
    switch (purpose) {
      case EmailTemplatePurpose.WELCOME:
        toCheckFor = `Thanks for getting started with Clairview's Clairview platform.`
        break
      case EmailTemplatePurpose.INVITATION:
        toCheckFor = `Use the button below to set up your account and get started:`
        break
      case EmailTemplatePurpose.PASSWORD_RECOVERY:
        toCheckFor = `You recently requested to reset your password for your Clairview account in your Clairview platform`
        break
    }
