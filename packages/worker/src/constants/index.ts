import { constants } from "@clairview/backend-core"
...
export const TemplateBindings = {
  PLATFORM_URL: {
    ...
    description: "The URL used to access the clairview platform",
  },
  COMPANY: {
  ...
  LOGIN_URL: {
    ...
    description: "The URL used to log into the organization clairview instance.",
  },
  CURRENT_YEAR: {
