import { env as coreEnv } from "@clairview/backend-core"
...
const environment = {
  ...
  // Clairview AI
  CLAIRVIEW_AI_API_KEY: process.env.CLAIRVIEW_AI_API_KEY,
  CLAIRVIEW_AI_DEFAULT_MODEL: process.env.CLAIRVIEW_AI_DEFAULT_MODEL,
