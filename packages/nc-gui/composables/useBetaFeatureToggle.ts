...
const FEATURES = [
  ...
  },
  {
    id: 'ai_features',
    title: 'AI features',
    description: 'Unlock AI features to enhance your ClairView experience.',
    enabled: false,
    isEngineering: true,
    isEE: true,
  },
  ...
  },
  {
    id: 'extensions',
    title: 'Extensions',
    description: 'Extensions allows you to add new features or functionalities to the ClairView platform.',
    enabled: false,
    isEngineering: true,
  },
  {
