...
const supportedDocs = [
  {
    title: 'Integrations',
    href: 'https://docs.clairview.com/category/integrations',
  },
  {
    title: 'Create new connection',
    href: 'https://docs.clairview.com/integrations/create-connection',
  },
  {
    title: 'Add new Data source',
    href: 'https://docs.clairview.com/data-sources/connect-to-data-source',
  },
] as {
  title: string
  href: string
