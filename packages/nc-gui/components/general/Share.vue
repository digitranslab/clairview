...
const summaryArr = [
  'Instant #Rest & #GraphQL APIs on any #SQL Database (Supports : MySQL, PostgresSQL, MsSQL, SQLite, MariaDB) #clairview ',
  'Instantly generate #Rest & #GraphQL APIs on any #SQL Database (Supports : MySQL, PostgresSQL, MsSQL, SQLite, MariaDB) #clairview',
  'Instant #serverless Rest & #GraphQL APIs on any Database #clairview',
  'Instant APIs on any SQL Database (Supports : #REST #GraphQL #MySQL, #PostgresSQL, #MsSQL, #SQLite, #MariaDB) #clairview',
  'Generate Instant APIs on any SQL Database (Supports : #REST #GraphQL #MySQL, #PostgresSQL, #MsSQL, #SQLite, #MariaDB) #clairview',
]

const shareUrl = computed(() => encodeURIComponent(url))

const encodedTitle = computed(() => encodeURIComponent(title || 'ClairView'))
