...
<template>
  ...
  <div v-else class="flex justify-between gap-1 w-full px-2">
    ...
    <div
      ...
      @click="open('https://community.clairview.com/')"
    >
      <div class="discourse" />
    </div>
    ...
    <component
      ...
      @click="open('https://www.reddit.com/r/ClairView/')"
    />
    ...
    <component
      ...
      @click="open('https://twitter.com/ClairView')"
    />
    ...
    <component
      ...
      @click="open('https://calendly.com/clairview-meeting')"
    />
  </div>
</template>
