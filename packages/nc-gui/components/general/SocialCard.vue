    ...
    <a-list class="w-full" dense>
      ...
      <a-list-item>
        <nuxt-link
          ...
          no-rel
          class="text-primary !no-underline !text-current"
          to="https://github.com/digitranslab/clairview"
          target="_blank"
        >
      ...
      <a-list-item>
        <nuxt-link
          ...
          to="https://calendly.com/clairview-meeting"
          target="_blank"
        >
          <div class="flex items-center text-sm">
      ...
      <a-list-item>
        <nuxt-link
          ...
          no-rel
          class="!no-underline !text-current"
          to="https://twitter.com/ClairView"
          target="_blank"
        >
          <div class="flex items-center text-sm">
            ...
            <!-- Follow ClairView -->
            <div>
              {{ $t('labels.community.followClairview') }}
            </div>
          </div>
        </nuxt-link>
      </a-list-item>
      ...
      <a-list-item>
        <nuxt-link
          ...
          class="!no-underline !text-current"
          target="_blank"
          to="https://www.reddit.com/r/ClairView/"
        >
          <div class="ml-3 flex items-center text-sm">
            <component :is="iconMap.reddit" color="red" />
            <span class="ml-4">/r/ClairView/</span>
          </div>
        </nuxt-link>
      </a-list-item>
