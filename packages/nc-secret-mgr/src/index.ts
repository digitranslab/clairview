...
program
  ...
  .option('--nc-db <char>', 'ClairView  connection database url, equivalent to NC_DB env variable')
  .option('--nc-db-json <char>', 'ClairView connection database json, equivalent to NC_DB_JSON env variable')
  .option('--nc-db-json-file <char>', 'ClairView connection database json file path, equivalent to NC_DB_JSON_FILE env variable')
