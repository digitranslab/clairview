...
export const PLUGIN_DEFINITIONS = {
  "clair-video": {
    component: "plugin/clair-video",
    description: "Embedded video component. ",
    friendlyName: "Clair Video",
    icon: "VideoOutline",
    name: "clair-video",
  },
}
...
export const componentDefinitionMap = () => {
  return Object.keys(COMPONENT_DEFINITIONS).reduce((acc, key) => {
    ...
    acc[`@clairview/standard-components/${key}`] = def
    return acc
  }, {})
}
...
export const generateAppPackage = ({
  ...
  return {
    application: {
      ...
      upgradableVersion,
      revertableVersion,
      componentLibraries: ["@clairview/standard-components"],
    ...
    clientLibPath: `https://cdn.clairview.net/${appId}/clairview-client.js?v=${version}`,
    hasLock: true,
  }
}
...
export const internalTableDoc = {
  ...
  type: "table",
  name: "Media",
  sourceId: CLAIRVIEW_INTERNAL_DB_ID,
  sourceType: DB_TYPE_INTERNAL,
