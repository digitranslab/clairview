<script>
  ...
  import { TestimonialPage } from "@clairview/frontend-core/src/components"
  ...
  $: company = $organisation.company || "Clairview"
  $: cloud = $admin.cloud
  ...
  <TestimonialPage enabled={$organisation.testimonialsEnabled}>
    <Layout gap="L" noPadding>
      <Layout justifyItems="center" noPadding>
        ...
        {/if}
        <Heading size="M">
          {$organisation.loginHeading || "Log in to Clairview"}
        </Heading>
      </Layout>
      ...
      {#if cloud}
        <Body size="xs" textAlign="center">
          By using Clairview Cloud
          <br />
          you are agreeing to our
          <Link
            href="https://clairview.com/eula"
            target="_blank"
            secondary={true}
          >
            License Agreement
