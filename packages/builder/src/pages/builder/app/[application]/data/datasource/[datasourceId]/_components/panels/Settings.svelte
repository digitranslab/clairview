<script>
  import { Body, Button, Layout, notifications } from "@clairview/bbui"
  import Panel from "./Panel.svelte"
  import { API } from "api"
  import { downloadText } from "@clairview/frontend-core"
...
<Panel>
  <div class="main">
    <Layout gap="S" noPadding>
      ...
      <Body>Download your schema to share with the Clairview team</Body>
