<script>
  ...
  import { notifications, Body, Icon, AbsTooltip } from "@clairview/bbui"
...
>
  <div class="subHeading">
    <Body>Get started with our Clairview DB</Body>
    <AbsTooltip text="Clairview DB is built with CouchDB">
  ...
  <div class="options">
    <DatasourceOption
      ...
      {disabled}
    >
      <svelte:component this={ICONS.CLAIRVIEW} height="20" width="20" />
    </DatasourceOption>
    <DatasourceOption
