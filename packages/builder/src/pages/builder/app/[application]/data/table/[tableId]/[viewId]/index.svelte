<script>
  ...
  import { Grid } from "@clairview/frontend-core"
  import { API } from "api"
  import { notifications } from "@clairview/bbui"
  ...
  import { ViewV2Type } from "@clairview/types"
...
<Grid
  ...
  allowAddRows
  allowDeleteRows
  aiEnabled={$featureFlags.CLAIRVIEW_AI || $featureFlags.AI_CUSTOM_CONFIGS}
  showAvatars={false}
