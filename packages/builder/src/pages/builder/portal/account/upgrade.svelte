<script>
  ...
  import { processStringSync } from "@clairview/string-templates"
  ...
  <Layout noPadding>
    <Layout gap="XS" noPadding>
      ...
      <Body size="M">
        {#if license.plan.type === "free"}
          Upgrade your Clairview installation to unlock additional features. To
    ...
    {#if $admin.offlineMode}
      <Layout gap="XS" noPadding>
        ...
        <Body size="S"
          >Share this with support@clairview.com to obtain your offline license</Body
        >
      </Layout>
      <Layout noPadding>
