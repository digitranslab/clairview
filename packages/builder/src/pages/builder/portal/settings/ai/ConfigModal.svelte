<script>
  import { ModalContent, Label, Input, Select, Toggle } from "@clairview/bbui"
...
>
  ...
  <div class="form-row">
    ...
    <Input
      error={config.name === "Clairview AI" ? "Cannot use this name" : null}
  ...
  <div class="form-row">
    ...
    <Input
      ...
      placeholder={"https://clairview.ai"}
