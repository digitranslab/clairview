<script>
  ...
  function buildRelationships() {
    ...
    if (manyToMany) {
      ...
      // table, this is due to the way that clairview represents relationships, the fieldName in a
...
>
  ...
  <Body>
    Clairview manages SQL relationships as a new column in the table, please
