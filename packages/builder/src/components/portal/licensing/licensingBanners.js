...
import { BANNER_TYPES } from "@clairview/bbui"
...
const buildUsersAboveLimitBanner = EXPIRY_KEY => {
  ...
  return {
    ...
    message: "Your Clairview account is de-activated. Upgrade your plan",
    ...{
      extraButtonText: "View plans",
      extraButtonAction: () => {
        defaultCacheFn(ExpiringKeys.LICENSING_USERS_ABOVE_LIMIT_BANNER)
        window.location.href = "https://clairview.com/pricing/"
      },
    },
