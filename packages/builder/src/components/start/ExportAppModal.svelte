<script>
  ...
  import { downloadFile } from "@clairview/frontend-core"
...
>
  {#if currentStep === Step.CONFIG}
    ...
    <InlineAlert
      header={encrypt
        ? "Please note Clairview does not encrypt attachments during the export process to ensure efficient export of large attachments."
        : "Do not share your Clairview application exports publicly as they may contain sensitive information such as database credentials or secret keys."}
    />
  {/if}
