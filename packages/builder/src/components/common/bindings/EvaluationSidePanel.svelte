<script>
  ...
  import { Icon, ProgressCircle, notifications } from "@clairview/bbui"
  import { copyToClipboard } from "@clairview/bbui/helpers"
  import { fade } from "svelte/transition"
  import { UserScriptError } from "@clairview/string-templates"
