<script>
  ...
  import { Popover, Heading, Body } from "@clairview/bbui"
...
<div bind:this={popoverAnchor} class="help">
  ...
  <Popover maxHeight={1000} bind:show bind:hide anchor={popoverAnchor}>
    <nav class="helpMenu">
      ...
      <div class="divider" />
      <a target="_blank" href="https://docs.clairview.com/docs">
        <div class="icon">
      ...
      <a
        target="_blank"
        href="https://github.com/clairview/clairview/discussions"
      >
        <div class="icon">
      ...
      <div class="divider" />
      <a target="_blank" href="https://vimeo.com/showcase/clairview-university">
        <div class="icon">
          <FontAwesomeIcon name="fa-solid fa-play" />
        </div>
        <Body size="S">Clairview University</Body>
      </a>
      <div class="divider" />
      <a
        href={premiumOrAboveLicense
          ? "mailto:support@clairview.com"
