<script>
  ...
  const getDocLink = columnType => {
    if (columnType === FieldType.NUMBER) {
      return "https://docs.clairview.com/docs/number"
    }
    if (columnType === FieldType.STRING) {
      return "https://docs.clairview.com/docs/text"
    }
    if (columnType === FieldType.LONGFORM) {
      return "https://docs.clairview.com/docs/text"
    }
    if (columnType === FieldType.ATTACHMENT_SINGLE) {
      return "https://docs.clairview.com/docs/attachments"
    }
    ...
    if (columnType === FieldType.ARRAY) {
      return "https://docs.clairview.com/docs/multi-select"
    }
    if (columnType === FieldType.JSON) {
      return "https://docs.clairview.com/docs/json"
    }
    if (columnType === "jsonarray") {
      return "https://docs.clairview.com/docs/json"
    }
    if (columnType === FieldType.DATETIME) {
      return "https://docs.clairview.com/docs/datetime"
    }
    if (columnType === FieldType.BB_REFERENCE_SINGLE) {
      return "https://docs.clairview.com/docs/users-1"
    }
    if (columnType === FieldType.BB_REFERENCE) {
      return "https://docs.clairview.com/docs/users-1"
    }
    if (columnType === FieldType.BARCODEQR) {
      return "https://docs.clairview.com/docs/barcodeqr"
    }
    if (columnType === FieldType.LINK) {
      return "https://docs.clairview.com/docs/relationships"
    }
    if (columnType === FieldType.FORMULA) {
      return "https://docs.clairview.com/docs/formula"
    }
    if (columnType === FieldType.AI) {
      return "https://docs.clairview.com/docs/ai"
    }
    if (columnType === FieldType.OPTIONS) {
      return "https://docs.clairview.com/docs/options"
    }
    if (columnType === FieldType.BOOLEAN) {
      return "https://docs.clairview.com/docs/boolean-truefalse"
    }
