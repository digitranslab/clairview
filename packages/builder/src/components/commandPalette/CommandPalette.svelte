<script>
  ...
  import { ThemeOptions } from "@clairview/shared-core"
  ...
  const commands = [
    ...
    },
    {
      ...
      icon: "Help",
      action: () =>
        window.open(`https://github.com/clairview/clairview/discussions/new`),
    },
    {
      type: "Support",
      name: "Raise A Bug",
      ...
      action: () =>
        window.open(
          `https://github.com/clairview/clairview/issues/new?assignees=&labels=bug&template=bug_report.md&title=`
        ),
    },
