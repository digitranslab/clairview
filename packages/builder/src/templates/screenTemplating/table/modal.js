...
const modal = async ({ tableOrView, permissions, screens }) => {
  /*
    Create Row
   */
  const createRowModal = new Component("@clairview/standard-components/modal")
    .instanceName("New row modal")
    .customProps({
      size: "large",
    })

  const buttonGroup = new Component("@clairview/standard-components/buttongroup")
  const createButton = new Component("@clairview/standard-components/button")
  ...
  const heading = new Component("@clairview/standard-components/heading")
  ...
  const createFormBlock = new Component(
    "@clairview/standard-components/formblock"
  )
  ...
  const detailsModal = new Component("@clairview/standard-components/modal")
    .instanceName("Edit row modal")
    .customProps({
      size: "large",
    })

  let editFormBlock = new Component("@clairview/standard-components/formblock")
  ...
  const tableBlock = new Component("@clairview/standard-components/gridblock")
  tableBlock
    .customProps({
