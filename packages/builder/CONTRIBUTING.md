### Contributing to clairview-core

* The contributors are listed in [AUTHORS.md](https://github.com/clairview/builder/blob/master/AUTHORS.md) (add yourself).

* This project uses a modified version of the MPLv2 license, see [LICENSE](https://github.com/clairview/builder/blob/master/LICENSE.md).
