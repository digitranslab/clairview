...
export default new Command(`${CommandWord.BACKUPS}`)
  .addHelp(
    "Allows building backups of Clairview, as well as importing a backup to a new instance."
  )
  .addSubOption(
    "--export [filename]",
    "Export a backup from an existing Clairview installation.",
    exportBackup
  )
  .addSubOption(
    "--import [filename]",
    "Import a backup to a new Clairview installation.",
    importBackup
  )
  .addSubOption(
    "--env [envFile]",
