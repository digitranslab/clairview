...
import * as nc_006_alter_cv_shared_views from './v1/nc_006_alter_cv_shared_views';
import * as nc_007_alter_cv_shared_views_1 from './v1/nc_007_alter_cv_shared_views_1';
import * as nc_008_add_cv_shared_bases from './v1/nc_008_add_cv_shared_bases';
...
export default class XcMigrationSource {
  ...
  public getMigrations(): Promise<any> {
    ...
    return Promise.resolve([
      ...
      'viewType',
      'viewName',
      'nc_006_alter_cv_shared_views',
      'nc_007_alter_cv_shared_views_1',
      'nc_008_add_cv_shared_bases',
  ...
  public getMigration(migration): any {
    switch (migration) {
      ...
      case 'viewName':
        return viewName;
      case 'nc_006_alter_cv_shared_views':
        return nc_006_alter_cv_shared_views;
      case 'nc_007_alter_cv_shared_views_1':
        return nc_007_alter_cv_shared_views_1;
      case 'nc_008_add_cv_shared_bases':
        return nc_008_add_cv_shared_bases;
