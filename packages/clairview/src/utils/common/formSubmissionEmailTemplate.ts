...
<head>
    ...
    <title>ClairView forms: someone has responded to Form</title>
    <style>
...
<span class="preheader"
      style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">ClairView forms: someone has responded to Form</span>
                        ...
                        <td class="wrapper"
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                                   ...
                                   <td style="font-family: sans-serif; font-size: 14px;padding: 20px 5px 10px 5px; " colspan="2">
                                     <a href="https://github.com/digitranslab/clairview" target="_blank">
                                        <img src="https://cdn.clairview.com/email/logo.png" alt="ClairView" width="150" style=" vertical-align: middle">
                                     </a>
                                   </td>
                                   </tr>
                                   <tr>
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td class="content-block powered-by"
                                style="font-family: sans-serif; vertical-align: top; padding-bottom: 10px; padding-top: 10px; color: #999999; font-size: 12px; text-align: center;"
                                valign="top" align="center">
                                <a href="https://github.com/digitranslab/clairview">ClairView</a>
