...
export class CallWebhookJobsJob {
  ...
  async handle(
    ...
    // trigger in packages/clairview-zapier/src/triggers/trigger_record.ts
    // Also change the openApi schema for webhooks
    // packages/clairview-server/src/engine/core-modules/open-api/utils/computeWebhooks.utils.ts

    const webhookRepository =
      await this.clairviewORMGlobalManager.getRepositoryForWorkspace<WebhookWorkspaceEntity>(
