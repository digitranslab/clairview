...
export class BlocklistItemDeleteCalendarEventsJob {
  ...
  async handle(data: BlocklistItemDeleteCalendarEventsJobData): Promise<void> {
    ...
    const blocklistRepository =
      await this.clairviewORMManager.getRepository<BlocklistWorkspaceEntity>(
        'blocklist',
      );
    ...
    const calendarChannelRepository =
      await this.clairviewORMManager.getRepository<CalendarChannelWorkspaceEntity>(
        'calendarChannel',
      );

    const calendarChannelEventAssociationRepository =
      await this.clairviewORMManager.getRepository<CalendarChannelEventAssociationWorkspaceEntity>(
