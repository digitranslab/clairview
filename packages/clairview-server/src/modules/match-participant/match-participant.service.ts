...
> {
  ...
  private async getParticipantRepository(
    ...
    if (objectMetadataName === 'messageParticipant') {
      return await this.clairviewORMManager.getRepository<MessageParticipantWorkspaceEntity>(
        objectMetadataName,
      );
    }

    return await this.clairviewORMManager.getRepository<CalendarEventParticipantWorkspaceEntity>(
      objectMetadataName,
    );
  }
  ...
  public async matchParticipants(
    ...
    const personRepository =
      await this.clairviewORMManager.getRepository<PersonWorkspaceEntity>(
        'person',
      );
    ...
    const workspaceMemberRepository =
      await this.clairviewORMManager.getRepository<WorkspaceMemberWorkspaceEntity>(
        'workspaceMember',
      );
