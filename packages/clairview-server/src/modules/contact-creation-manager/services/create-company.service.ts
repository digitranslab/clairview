...
export class CreateCompanyService {
  ...
  constructor(private readonly clairviewORMGlobalManager: ClairviewORMGlobalManager) {
    this.httpService = axios.create({
      baseURL: 'https://clairview-companies.com',
    });
  }
  ...
  async createCompanies(
    ...
    const companyRepository =
      await this.clairviewORMGlobalManager.getRepositoryForWorkspace(
        workspaceId,
