...
export class MessagingCreateCompanyAndContactAfterSyncJob {
  ...
  async handle(
    ...
    const messageChannelRepository =
      await this.clairviewORMManager.getRepository<MessageChannelWorkspaceEntity>(
        'messageChannel',
      );
    ...
    const connectedAccountRepository =
      await this.clairviewORMManager.getRepository<ConnectedAccountWorkspaceEntity>(
        'connectedAccount',
      );
    ...
    const messageParticipantRepository =
      await this.clairviewORMManager.getRepository<MessageParticipantWorkspaceEntity>(
        'messageParticipant',
      );
