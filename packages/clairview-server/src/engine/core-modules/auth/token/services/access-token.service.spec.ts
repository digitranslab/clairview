...
describe('AccessTokenService', () => {
  ...
  let clairviewORMGlobalManager: ClairviewORMGlobalManager;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: ClairviewORMGlobalManager,
          useValue: {
    ...
    clairviewORMGlobalManager = module.get<ClairviewORMGlobalManager>(
  ...
  describe('generateAccessToken', () => {
    it('should generate an access token successfully', async () => {
      ...
      jest
        .spyOn(clairviewORMGlobalManager, 'getRepositoryForWorkspace')
        .mockResolvedValue({
