---
title: 'Grid'
description: 'Learn how to work with grid view in ClairView.'
tags: ['Views', 'Grid view']
keywords : ['ClairView grid', 'grid view', 'grid']
---

Grid View, as a default type of view, allows you to display your data in a spreadsheet-like interface using rows and columns. Rows are as referred to as records and columns as fields in ClairView.
