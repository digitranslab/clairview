---
title: 'Data Exporter'
description: 'Export data from ClairView in various formats'
...
## Overview
The Data Exporter extension is designed to simplify the process of exporting data from your ClairView tables. With just a few clicks, you can effortlessly download CSV files for any specific table and view within your base. The download process is handled asynchronously in the background, ensuring that your application usage remains uninterrupted. Once your file is ready, you’ll receive a notification, allowing you to download the CSV into your local machine at your convenience.

## Exporting Data
Follow these steps to export data from your ClairView tables:
