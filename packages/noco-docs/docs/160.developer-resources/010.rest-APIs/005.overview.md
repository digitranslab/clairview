...
- [Meta APIs](https://meta-apis-v2.clairview.com/)

- [Data APIs](https://data-apis-v2.clairview.com/)

You will need an API key and endpoint to use the API. The endpoint URL for hosted instances of ClairView is in the format `https://app.clairview.com/api/v2/tables/TABLEID/records` and `https://app.clairview.com/api/v2/meta/bases/BASEID/info`.

- You can find a TABLEID by going to any table in ClairView > Details > API Snippets.
