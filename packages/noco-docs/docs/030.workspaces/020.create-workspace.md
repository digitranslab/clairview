...
description: 'Learn how to create a workspace in ClairView'
tags: ['Workspaces', 'Create']
keywords: ['ClairView workspace', 'create workspace', 'workspace context menu', 'workspace owner', 'workspace collaboration', 'workspace actions', 'default workspace']
---

Upon signing up to ClairView, an initial workspace is automatically generated on your behalf.
...
In the following section, lets look at the process of creating your ClairView workspaces.
