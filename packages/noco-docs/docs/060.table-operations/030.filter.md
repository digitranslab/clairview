...
description: 'Learn how to filter records in ClairView.'
tags: ['Table operations', 'Filter', 'Gallery view', 'Kanban view', 'Grid view']
keywords: ['ClairView table operations', 'table operations overview', 'filter']
---


Filters provide a powerful way to narrow down and organize your data according to your specific requirements. ClairView supports nested filters, allowing you to select multiple fields and conditions for filtering. You can choose between `and` or `or` mode of operation to combine filters, and filtering also supports Lookup, Formula, and Nested Data.
...
### Supported Filters
ClairView currently supports various types of filters for corresponding fields. Please refer to the matrix below for detailed information.
