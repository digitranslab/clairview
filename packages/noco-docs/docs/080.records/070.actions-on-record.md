...
description: 'Learn how to perform actions (edit, duplicate, delete, etc) on a record in ClairView.'
tags: ['Records', 'Delete', 'Edit', 'Duplicate', 'Shortcuts']
keywords : ['ClairView delete record', 'delete record', 'delete row', 'delete rows']
---
