...
Once you have created a new ClairView project you can open it, In the browser, the URL would be like `example.com/#/default/<project_id>`.
...
![table-create-button](https://github.com/digitranslab/clairview/assets/86527202/0b1d0b89-b3c6-4c3c-8208-4b6afce67d23)

Provide a name for the table & click `Create Table` button.

![table-create-modal](https://github.com/digitranslab/clairview/assets/86527202/fceb6c48-e0d6-428c-bb16-d2da4e38a81f)
