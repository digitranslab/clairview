...
Additional access details for project level permissions can be found [here](https://docs.clairview.com/setup-and-usages/team-and-auth#advanced-options--configurations).
