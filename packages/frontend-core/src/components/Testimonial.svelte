<script>
  import { Layout } from "@clairview/bbui"
  ...
  const testimonials = [
    {
      text: "Clairview was the only solution that checked all the boxes for Covanta. Covanta expects to realize $3.2MM in savings due to the elimination of redundant data entry.",
      name: "Charles Link",
    ...
    {
      text: "Clairview was mission-critical for us and went a long way in preventing what could have become a humanitarian crisis here in Bulgaria.",
