...
export function generateMetadata({
  ...
  return {
    metadataBase: new URL(`https://clairview.io`),
    title: 'Clairview - ' + params.slug,
    description:
      'Explore the impactful contributions of ' +
      params.slug +
      ' on the Clairview Github Repo. Discover their merged pull requests, ongoing work, and top ranking. Join and contribute to the #1 Open-Source CRM thriving community!',
    openGraph: {
      images: [`https://clairview.io/api/contributors/${params.slug}/og.png`],
    },
  };
}
