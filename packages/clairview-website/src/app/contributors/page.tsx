...
import { CLAIRVIEW_TEAM_MEMBERS } from '@/shared-utils/listTeamMembers';

export const metadata = {
  title: 'Clairview - Contributors',
  description:
    'Discover the brilliant minds behind Clairview.io. Meet our contributors and explore how their expertise contributes to making Clairview the leading open-source CRM. Join our community today.',
...
const Contributors = async () => {
  ...
  const fitlerContributors = contributors
    ...
    .filter((contributor) => !CLAIRVIEW_TEAM_MEMBERS.includes(contributor.id))
    .map((contributor) => {
