---
title: Glossary
info: Get familiar with essential terminology used in Clairview.
icon: IconVocabulary
...
## Workspace
A `Workspace` typically represents a company using Clairview. It holds all the records and data that you and your team members add to Clairview.
...
## Tasks 
Tasks in Clairview CRM are assigned activities relating to contacts, accounts, or opportunities.

## Opportunities 
Opportunities in Clairview CRM are potential deals or sales with accounts or contacts.

## Integration 
Integration are built-in tools that allow to link Clairview with other software or systems.

## User Profile
A User Profile is the information and settings specific to a workspace member in Clairview.
