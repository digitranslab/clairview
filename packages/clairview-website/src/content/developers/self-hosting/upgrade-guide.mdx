...
1. In a terminal, on the host where Clairview is running, turn off Clairview: `docker compose down`

2. Upgrade the version by changing the `TAG` value in the .env file near your docker-compose.

3. Bring Clairview back online with `docker-compose up -d`
...
Upgrade your Clairview instance to use v0.34.0 image
...
Upgrade your Clairview instance to use v0.33.0 image
...
Upgrade your Clairview instance to use v0.32.0 image
...
Upgrade your Clairview instance to use v0.31.0 image
...
Upgrade your Clairview instance to use v0.30.0 image

**Breaking change**: 
To enhance performances, Clairview now requires redis cache to be configured. We have updated our [docker-compose.yml](https://raw.githubusercontent.com/digitranslab/clairview/main/packages/clairview-docker/docker-compose.yml) to reflect this.
...
Upgrade your Clairview instance to use v0.24.0 image
...
Upgrade your Clairview instance to use v0.23.0 image
...
Upgrade your Clairview instance to use v0.22.0 image
