...
Objects are structures that allow you to store data (records, attributes, and values) specific to an organization. Clairview provides both standard and custom objects.

Standard objects are in-built objects with a set of attributes available for all users. Examples of standard objects in Clairview include Company and Person. Standard objects have standard fields that are also available for all Clairview users, like Company.displayName.
