...
<SandpackEditor content={`import { RawLink } from "clairview-ui";
...
<SandpackEditor content={`import { RoundedLink } from "clairview-ui";
import { BrowserRouter as Router } from "react-router-dom";
...
<SandpackEditor content={`import { SocialLink } from "clairview-ui";
import { BrowserRouter as Router } from "react-router-dom";
...
export const MyComponent = () => {
  return (
    <Router>
      <SocialLink
        type="twitter"
        href="https://twitter.com/clairviewcrm"
      ></SocialLink>
    </Router>
  );
};`} />
