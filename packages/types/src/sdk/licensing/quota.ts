...
export enum MonthlyQuotaName {
  ...
  CLAIRVIEW_AI_CREDITS = "clairviewAICredits",
}
...
export type MonthlyQuotas = {
  ...
  [MonthlyQuotaName.CLAIRVIEW_AI_CREDITS]: Quota
}
...
export interface Quota {
   ...
   * at in relation to the corresponding usage inside clairview.
   *
   * Triggering results in a clairview installation sending a request to account-portal,
