...
export const SETTINGS_COMPOSITE_FIELD_TYPE_CONFIGS = {
  ...
  [FieldMetadataType.Emails]: {
    ...
    exampleValue: {
      primaryEmail: 'john@clairview.io',
      additionalEmails: [
        'tim@clairview.io',
        'timapple@clairview.io',
        'johnappletim@clairview.io',
      ],
    },
    category: 'Basic',
  ...
  [FieldMetadataType.Links]: {
    ...
    exampleValue: {
      primaryLinkUrl: 'clairview.io',
      primaryLinkLabel: '',
      secondaryLinks: [{ url: 'clairview.io', label: 'Clairview' }],
    },
    category: 'Basic',
