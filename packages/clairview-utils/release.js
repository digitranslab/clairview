...
const frontPackageJson = path.join(__dirname, '../clairview-front/package.json');
const serverPackageJson = path.join(__dirname, '../clairview-server/package.json');
const emailPackageJson = path.join(__dirname, '../clairview-emails/package.json');
